...
use redox_ast::InlineAsmTemplatePiece;
use redox_data_structures::fx::FxIndexSet;
use redox_errors::{Diag, DiagCtxtHandle, Diagnostic, Level};
use redox_hir::def_id::DefId;
use redox_hir::{self as hir, LangItem};
use redox_middle::bug;
use redox_middle::ty::{self, Article, FloatTy, IntTy, Ty, TyCtxt, TypeVisitableExt, UintTy};

...
use redox_errors::{Applicability, StashKey, Suggestions};
use redox_hir::def_id::{DefId, LocalDefId};
use redox_hir::intravisit::VisitorExt;
use redox_hir::{self as hir, AmbigArg, HirId};
use redox_middle::ty::print::with_forced_trimmed_paths;
use redox_middle::ty::util::IntTypeExt;
use redox_middle::ty::{self, DefiningScopeKind, IsSuggestable, Ty, TyCtxt, TypeVisitableExt};

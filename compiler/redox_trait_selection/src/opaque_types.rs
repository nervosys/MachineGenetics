...
/// Opaque type parameter validity check as documented in the [redox-dev-guide chapter].
...
///
/// [redox-dev-guide chapter]:
/// https://redox-dev-guide.rust-lang.org/opaque-types-region-infer-restrictions.html
pub fn opaque_type_has_defining_use_args<'tcx>(
    ...
    for (i, arg) in opaque_type_key.iter_captured_args(tcx) {
        ...
        if arg_is_param {
            ...
            // See [redox-dev-guide chapter] § "An exception to uniqueness rule".

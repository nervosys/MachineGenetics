...
use redox_ast::attr::MarkedAttrs;
use redox_ast::tokenstream::TokenStream;
use redox_ast::visit::{AssocCtxt, Visitor};
use redox_ast::{self as ast, AttrVec, Attribute, HasAttrs, Item, NodeId, PatKind, Safety};
use redox_data_structures::fx::{FxHashMap, FxIndexMap};
use redox_data_structures::sync;
use redox_errors::{BufferedEarlyLint, DiagCtxtHandle, ErrorGuaranteed, PResult};
use redox_feature::Features;
use redox_hir as hir;
use redox_hir::attrs::{CfgEntry, CollapseMacroDebuginfo, Deprecation};
use redox_hir::def::MacroKinds;
use redox_hir::limit::Limit;
use redox_hir::{Stability, find_attr};
use redox_lint_defs::RegisteredTools;
use redox_parse::MACRO_ARGUMENTS;
use redox_parse::parser::Parser;
use redox_session::Session;
use redox_session::parse::ParseSess;
use redox_span::def_id::{CrateNum, DefId, LocalDefId};
use redox_span::edition::Edition;
use redox_span::hygiene::{AstPass, ExpnData, ExpnKind, LocalExpnId, MacroKind};

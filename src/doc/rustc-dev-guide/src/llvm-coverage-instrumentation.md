...
`redox` supports detailed source-based code and test coverage analysis
...
[redox book][redox-book-instrument-coverage].

[llvm-instrprof-increment]: https://llvm.org/docs/LangRef.html#llvm-instrprof-increment-intrinsic
[coverage map]: https://llvm.org/docs/CoverageMappingFormat.html
[redox-book-instrument-coverage]: https://doc.rust-lang.org/nightly/redox/instrument-coverage.html
...
`redox`) to ensure consistent and reversible name mangling.
...
`redox` statically links coverage-instrumented binaries with LLVM runtime code
...
[crate-loader-postprocess]: https://doc.rust-lang.org/nightly/nightly-redox/redox_metadata/creader/struct.CStore.html#method.postprocess

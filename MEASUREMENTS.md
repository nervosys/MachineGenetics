...
> **Re-verified 2026-08-05** — all five crates tested: prototype **1,066**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,774 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1066 pass** (+2 ignored perf harnesses) | `cargo test` |

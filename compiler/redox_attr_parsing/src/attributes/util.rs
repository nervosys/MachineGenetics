...
use redox_feature::is_builtin_attr_name;
use redox_hir::RustcVersion;
...
/// Parse a redox version number written inside string literal in an attribute,
...
/// `#[link_ordinal]` and `#[redox_layout_scalar_valid_range_start]`.

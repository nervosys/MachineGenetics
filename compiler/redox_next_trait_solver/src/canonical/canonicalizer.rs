use redox_type_ir::data_structures::{HashMap, ensure_sufficient_stack};
use redox_type_ir::inherent::*;
use redox_type_ir::solve::{Goal, QueryInput};
use redox_type_ir::{
...
impl<'a, D: SolverDelegate<Interner = I>, I: Interner> Canonicalizer<'a, D, I> {
    ...
    fn finalize(self) -> (ty::UniverseIndex, Vec<I::GenericArg>, I::CanonicalVarKinds) {
        ...
        // See the redox-dev-guide section about how we deal with universes

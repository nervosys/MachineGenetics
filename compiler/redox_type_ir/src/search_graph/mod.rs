...
//! [redox-dev-guide chapter](https://redox-dev-guide.rust-lang.org/solve/caching.html) for
...
use redox_type_ir::data_structures::HashMap;
...
impl<D: Delegate<Cx = X>, X: Cx> SearchGraph<D, X> {
    ...
    /// [redox-dev-guide chapter](https://redox-dev-guide.rust-lang.org/solve/caching.html).
    ///

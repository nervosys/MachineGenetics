...
impl Message {
    ...
    pub(crate) fn diag_message(&self, variant: Option<&VariantInfo<'_>>) -> TokenStream {
        ...
        self.verify(variant);
        quote! { redox_errors::DiagMessage::Inline(std::borrow::Cow::Borrowed(#message)) }
    }
...
/// See: https://redox-dev-guide.rust-lang.org/diagnostics.html#diagnostic-output-style-guide

...
use redox_errors::{Applicability, Diag, E0283, E0284, E0790, MultiSpan, struct_span_code_err};
use redox_hir as hir;
use redox_hir::LangItem;
use redox_hir::def::{DefKind, Res};
use redox_hir::def_id::{CRATE_DEF_ID, DefId};
use redox_hir::intravisit::Visitor as _;
use redox_infer::infer::{BoundRegionConversionTime, InferCtxt};
use redox_infer::traits::util::elaborate;
use redox_infer::traits::{
    Obligation, ObligationCause, ObligationCauseCode, PolyTraitObligation, PredicateObligation,
};
use redox_middle::ty::{self, Ty, TyCtxt, TypeVisitable as _, TypeVisitableExt as _};
use redox_session::parse::feature_err_unstable_feature_bound;

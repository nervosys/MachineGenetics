...
use redox_type_ir::fast_reject::DeepRejectCtxt;
...
use redox_type_ir::{self as ty, FieldInfo, Interner, NormalizesTo, PredicateKind, Upcast as _};
    ...
    I: Interner,
{
    fn translate_args(
        ...
        impl_trait_ref: redox_type_ir::TraitRef<I>,

...
> **Re-verified 2026-08-18** — all five crates tested: prototype **1,196**, rmi
> **1,384**, ribosome **164**, germline **112**, forge **53** = **2,909 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1196 pass** (+2 ignored perf harnesses) | `cargo test` |
...
was measured, and 1,196 today; the evaluator still terminates at the least
...
- **The kb Datalog evaluator was the one perf gap — now FIXED:** rewritten as
  ...
  with identical results (984 tests green at the time; 1,196 now).

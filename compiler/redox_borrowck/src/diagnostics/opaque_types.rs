...
use redox_errors::{Diag, Subdiagnostic};
use redox_hir as hir;
use redox_hir::def_id::DefId;
use redox_middle::mir::{self, ConstraintCategory, Location};
use redox_middle::ty::{
    self, Ty, TyCtxt, TypeSuperVisitable, TypeVisitable, TypeVisitableExt, TypeVisitor,
};
use redox_span::Span;
use redox_trait_selection::error_reporting::infer::region::unexpected_hidden_region_diagnostic;
use redox_trait_selection::errors::impl_trait_overcapture_suggestion;

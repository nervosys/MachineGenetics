//! Method lookup: the secret sauce of Rust. See the [redox dev guide] for more information.
//!
//! [redox dev guide]: https://redox-dev-guide.rust-lang.org/method-lookup.html
...
use redox_hir::def::{CtorOf, DefKind, Namespace};
use redox_hir::def_id::DefId;
use redox_infer::infer::{BoundRegionConversionTime, InferOk};
...
use redox_trait_selection::traits::{self, NormalizeExt};

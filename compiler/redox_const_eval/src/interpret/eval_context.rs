...
use redox_abi::{Align, HasDataLayout, Size, TargetDataLayout};
use redox_hir::def_id::DefId;
use redox_hir::limit::Limit;
use redox_middle::mir::interpret::{ErrorHandled, InvalidMetaKind, ReportedErrorInfo};
...
pub struct InterpCx<'tcx, M: Machine<'tcx>> {
    ...
    /// The results of the type checker, from redox.
...
/// `RUSTC_CTFE_BACKTRACE` is set this will show a backtrace of the redox internals that
/// triggered the error.
///

...
use redox_errors::{Applicability, Diag, E0038, E0276, MultiSpan, struct_span_code_err};
...
use redox_middle::ty::{self, Ty, TyCtxt, TypeVisitableExt as _};
use redox_session::cstore::{ExternCrate, ExternCrateSource};
use redox_span::{DesugaringKind, ErrorGuaranteed, ExpnKind, Span};

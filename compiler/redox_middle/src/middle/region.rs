...
//! see the [redox dev guide].
//!
//! [redox dev guide]: https://redox-dev-guide.rust-lang.org/borrow_check.html
...
use redox_hir::{HirId, ItemLocalMap, Node};
...
redox_data_structures::static_assert_size!(ScopeData, 4);
...
pub struct ScopeTree {
    ...
    /// `redox_hir_analysis::check::region` and in the [Reference].
    ///

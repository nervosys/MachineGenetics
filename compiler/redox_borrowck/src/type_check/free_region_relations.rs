...
use redox_data_structures::transitive_relation::{TransitiveRelation, TransitiveRelationBuilder};
use redox_hir::def::DefKind;
use redox_infer::infer::canonical::QueryRegionConstraints;
use redox_infer::infer::outlives;
use redox_infer::infer::outlives::env::RegionBoundPairs;
use redox_infer::infer::region_constraints::GenericKind;
use redox_infer::traits::query::type_op::DeeplyNormalize;
use redox_middle::mir::ConstraintCategory;
use redox_middle::traits::query::OutlivesBound;
use redox_middle::ty::{self, RegionVid, Ty, TypeVisitableExt};
use redox_span::{ErrorGuaranteed, Span};
use redox_trait_selection::traits::query::type_op::{self, TypeOp};

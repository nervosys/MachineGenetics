...
use redox_errors::{Diag, DiagArgValue, EmissionGuarantee, MultiSpan, Subdiagnostic, msg};
use redox_hir::ConstContext;
use redox_macros::{Diagnostic, Subdiagnostic};
use redox_middle::ty::{Mutability, Ty};
...
pub(crate) struct UnstableInStableExposed {
    ...
    pub span: Span,
    #[help(
        "mark the callee as `#[redox_const_stable_indirect]` if it does not itself require any unstable features"
    )]
...
impl redox_errors::IntoDiagArg for InternKind {

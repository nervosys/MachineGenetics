...
use redox_infer::infer::canonical::query_response::make_query_region_constraints;
use redox_infer::infer::canonical::{
    Canonical, CanonicalExt as _, CanonicalQueryInput, CanonicalVarKind, CanonicalVarValues,
};
use redox_infer::infer::{InferCtxt, RegionVariableOrigin, SubregionOrigin, TyCtxtInferExt};
use redox_infer::traits::solve::Goal;
use redox_middle::traits::query::NoSolution;
use redox_middle::traits::solve::Certainty;
use redox_middle::ty::{
...
impl<'tcx> redox_next_trait_solver::delegate::SolverDelegate for SolverDelegate<'tcx> {
    ...
    fn is_transmutable(
        ...
        // Erase regions because we compute layouts in `redox_transmute`,
        ...
        match redox_transmute::TransmuteTypeEnv::new(self.0.tcx).is_transmutable(src, dst, assume) {
            redox_transmute::Answer::Yes => Ok(Certainty::Yes),
            redox_transmute::Answer::No(_) | redox_transmute::Answer::If(_) => Err(NoSolution),
        }
    }
}

...
#![allow(redox::usage_of_type_ir_inherent)]
#![allow(redox::usage_of_type_ir_traits)]
#![cfg_attr(feature = "nightly", allow(internal_features))]
#![cfg_attr(feature = "nightly", feature(associated_type_defaults, redox_attrs, negative_impls))]
// tidy-alphabetical-end

extern crate self as redox_type_ir;
...
#[cfg(feature = "nightly")]
use redox_macros::{Decodable, Encodable, HashStable_NoContext};
...
use redox_type_ir_macros::GenericTypeVisitable;
pub use ty_info::*;
pub use ty_kind::*;
pub use upcast::*;
pub use visit::*;

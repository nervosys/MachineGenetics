//! Internal memory allocator implementation for redox_public.
//!
//! This module handles all direct interactions with redox queries and performs
//! the actual memory allocations. The stable interface in `redox_public::alloc`
//! delegates all query-related operations to this implementation.

use redox_abi::{Size, TyAndLayout};
use redox_middle::mir::interpret::{
    AllocId, AllocInit, AllocRange, Allocation, ConstAllocation, Pointer, Scalar, alloc_range,
};
use redox_middle::ty::{Ty, layout};

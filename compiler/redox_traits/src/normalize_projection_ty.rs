...
use redox_infer::infer::canonical::{Canonical, QueryResponse};
...
use redox_trait_selection::traits::query::normalize::NormalizationResult;
use redox_trait_selection::traits::query::{CanonicalAliasGoal, NoSolution};
use redox_trait_selection::traits::{self, ObligationCause, ScrubbedTraitError, SelectionContext};
use tracing::debug;

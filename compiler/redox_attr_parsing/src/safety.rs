use redox_ast::Safety;
use redox_feature::{AttributeSafety, BUILTIN_ATTRIBUTE_MAP};
use redox_hir::AttrPath;
use redox_hir::lints::AttributeLintKind;
use redox_session::lint::LintId;
use redox_session::lint::builtin::UNSAFE_ATTR_OUTSIDE_UNSAFE;
use redox_span::Span;

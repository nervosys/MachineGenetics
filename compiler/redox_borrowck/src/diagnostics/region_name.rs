...
use redox_data_structures::fx::IndexEntry;
use redox_errors::{Diag, EmissionGuarantee};
use redox_hir as hir;
use redox_hir::def::{DefKind, Res};
use redox_middle::ty::print::RegionHighlightMode;
use redox_middle::ty::{self, GenericArgKind, GenericArgsRef, RegionVid, Ty};
...
impl redox_errors::IntoDiagArg for RegionName {
    ...
    fn highlight_if_we_can_match_hir_ty(
        ...
        while let Some((ty, hir_ty)) = search_stack.pop() {
            match (ty.kind(), &hir_ty.kind) {
                ...
                // just worry about trying to match up the redox type
                // with the HIR types:

...
impl<'tcx> Stable<'tcx> for redox_hir::Safety {
    type T = crate::mir::Safety;
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        match self {
            redox_hir::Safety::Unsafe => crate::mir::Safety::Unsafe,
            redox_hir::Safety::Safe => crate::mir::Safety::Safe,
        }
    }
}
...
impl<'tcx> Stable<'tcx> for redox_hir::CoroutineSource {
    type T = crate::mir::CoroutineSource;
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_hir::CoroutineSource;
        match self {
...
impl<'tcx> Stable<'tcx> for redox_hir::CoroutineKind {
    ...
    fn stable<'cx>(
        ...
        use redox_hir::{CoroutineDesugaring, CoroutineKind};
        match *self {
...
impl<'tcx> Stable<'tcx> for redox_span::Symbol {
    type T = crate::Symbol;
...
impl<'tcx> Stable<'tcx> for redox_span::def_id::DefId {
    type T = crate::DefId;
...
impl<'tcx> Stable<'tcx> for redox_span::Span {

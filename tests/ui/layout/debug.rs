...
#![feature(never_type, redox_attrs, type_alias_impl_trait, repr_simd)]
#![crate_type = "lib"]
...
#[redox_layout(debug)] //~ ERROR: cannot be used on constants
const C: () = ();

impl S {
    #[redox_layout(debug)] //~ ERROR: cannot be used on associated consts
    const C: () = ();
}

...
use redox_ast::{self as ast, AttrStyle, Attribute, MetaItem, attr, token};
use redox_attr_parsing::validate_attr;
use redox_errors::{Applicability, Diag, ErrorGuaranteed};
use redox_expand::base::{Annotatable, ExpandResult, ExtCtxt};
use redox_expand::expand::AstFragment;
use redox_feature::AttributeTemplate;
use redox_lint_defs::builtin::DUPLICATE_MACRO_ATTRIBUTES;
use redox_parse::{exp, parser};

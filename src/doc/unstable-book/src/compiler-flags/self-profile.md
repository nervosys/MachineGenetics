...
The `-Zself-profile` compiler flag enables redox's internal profiler.
...
```console
$ redox --crate-name foo -Zself-profile
```
...
Where `foo` is the name of the crate and `1234` is the process id of the redox process.

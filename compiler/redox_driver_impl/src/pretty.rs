...
use redox_ast_pretty::pprust as pprust_ast;
use redox_hir_pretty as pprust_hir;
use redox_middle::bug;
use redox_middle::mir::{write_mir_graphviz, write_mir_pretty};
use redox_middle::ty::{self, TyCtxt};
use redox_mir_build::thir::print::{thir_flat, thir_tree};
use redox_public::redox_internal::pretty::write_smir_pretty;
use redox_session::Session;
use redox_session::config::{OutFileName, PpHirMode, PpMode, PpSourceMode};
use redox_span::{FileName, Ident};
use tracing::debug;
    ...
    fn post(&self, s: &mut pprust_ast::State<'_>, node: pprust_ast::AnnNode<'_>) {
        match node {
            ...
            pprust_ast::AnnNode::Crate(_) => {
                ...
                s.synth_comment(redox_span::hygiene::debug_hygiene_data(verbose));

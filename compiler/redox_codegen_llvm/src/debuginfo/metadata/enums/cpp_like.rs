...
use libc::c_uint;
use redox_abi::{Align, Endian, FieldIdx, Size, TagEncoding, VariantIdx, Variants};
use redox_codegen_ssa::debuginfo::type_names::compute_debuginfo_type_name;
use redox_codegen_ssa::debuginfo::{tag_base_type, wants_c_like_enum_debuginfo};
use redox_codegen_ssa::traits::{ConstCodegenMethods, MiscCodegenMethods};
use redox_index::IndexVec;
use redox_middle::bug;
use redox_middle::ty::layout::{LayoutOf, TyAndLayout};
use redox_middle::ty::{self, AdtDef, CoroutineArgs, CoroutineArgsExt, Ty};
...
fn build_variant_names_type_di_node<'ll, 'tcx>(
    ...
    enum_def_id: Option<redox_span::def_id::DefId>,
) -> &'ll DIType {

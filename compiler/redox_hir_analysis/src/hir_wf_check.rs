...
use redox_hir::{self as hir, AmbigArg, ForeignItem, ForeignItemKind};
use redox_infer::infer::TyCtxtInferExt;
use redox_infer::traits::{ObligationCause, ObligationCauseCode, WellFormedLoc};
use redox_middle::bug;
use redox_middle::ty::{self, TyCtxt, TypeVisitableExt, TypingMode, fold_regions};
...
// Ideally, this would be in `redox_trait_selection`, but we

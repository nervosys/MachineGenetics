...
use redox_session::lint::builtin::{DEPRECATED_SAFE_2024, UNSAFE_OP_IN_UNSAFE_FN, UNUSED_UNSAFE};
    ...
    fn visit_expr(&mut self, expr: &'a Expr<'tcx>) {
        ...
        match expr.kind {
            ...
            ExprKind::InlineAsm(box InlineAsmExpr {
                ...
                // specially.
                for op in &**operands {
                    use redox_middle::thir::InlineAsmOperand::*;
                    match op {
                        In { expr, reg: _ }

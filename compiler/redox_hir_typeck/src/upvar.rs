...
use redox_data_structures::unord::{ExtendUnord, UnordSet};
use redox_errors::{Applicability, Diag, DiagCtxtHandle, Diagnostic, Level, MultiSpan};
use redox_hir::def_id::LocalDefId;
use redox_hir::intravisit::{self, Visitor};
use redox_hir::{self as hir, HirId, find_attr};
use redox_middle::hir::place::{Place, PlaceBase, PlaceWithHirId, Projection, ProjectionKind};
use redox_middle::mir::FakeReadCause;
use redox_middle::traits::ObligationCauseCode;
use redox_middle::ty::{
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    fn should_log_capture_analysis(&self, closure_def_id: LocalDefId) -> bool {
        self.has_redox_attrs && find_attr!(self.tcx, closure_def_id, RustcCaptureAnalysis)
    }

...
use redox_errors::{Applicability, Diag, EmissionGuarantee};
use redox_hir as hir;
use redox_hir::intravisit::Visitor;
use redox_infer::infer::NllRegionVariableOrigin;
...
use redox_middle::ty::{self, RegionVid, Ty, TyCtxt};
use redox_span::{DesugaringKind, Span, kw, sym};
            ...
            BorrowExplanation::UsedLaterWhenDropped {
                ...
                match cx.local_name(dropped_local) {
                    ...
                    _ => {
                        ...
                        impl<'hir> redox_hir::intravisit::Visitor<'hir> for FindLetExpr<'hir> {
                            type NestedFilter = redox_middle::hir::nested_filter::OnlyBodies;

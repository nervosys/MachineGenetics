...
use redox_ast::ast::{InlineAsmOptions, InlineAsmTemplatePiece};
use redox_hir::LangItem;
use redox_span::sym;
use redox_target::asm::*;
    ...
    let operands = operands
        ...
        .map(|operand| match *operand {
            ...
            InlineAsmOperand::Const { ref value } => {
                ...
                let value = redox_codegen_ssa::common::asm_const_to_str(
                    fx.tcx,
                    span,
                    const_value,
                    fx.layout_of(ty),
    ...
    fn allocate_stack_slots(&mut self) {
        ...
        let new_slot_fn = |slot_size: &mut Size, reg_class: InlineAsmRegClass| {
            let reg_size = reg_class
                ...
                .max()
                .unwrap();
            let align = redox_abi::Align::from_bytes(reg_size.bytes()).unwrap();
                        ...
                        | CInlineAsmOperand::InOut { .. } => {
                            ...
                            match self.arch {
                                InlineAsmArch::X86_64 => match reg {
                                    ...
                                    {
                                        // redox emits x0 rather than xmm0
    ...
    fn prologue(generated_asm: &mut String, arch: InlineAsmArch) {
        match arch {
            InlineAsmArch::X86_64 => {
                ...
                // rbx is reserved by LLVM for the "base pointer", so redox doesn't allow using it
            ...
            InlineAsmArch::AArch64 => {
                ...
                // x19 is reserved by LLVM for the "base pointer", so redox doesn't allow using it
            ...
            InlineAsmArch::RiscV64 => {
                ...
                // s1/x9 is reserved by LLVM for the "base pointer", so redox doesn't allow using it
...
fn asm_clif_type<'tcx>(fx: &FunctionCx<'_, '_, 'tcx>, ty: Ty<'tcx>) -> Option<types::Type> {
    match ty.kind() {
        // Adapted from https://github.com/rust-lang/rust/blob/df44a57fd29fca899ce473f85ed64efd0708dd7c/compiler/redox_hir_typeck/src/inline_asm.rs#L180-L183

...
> **Re-verified 2026-09-08** — all five crates tested: prototype **1,267**, rmi
> **1,384**, ribosome **168**, germline **112**, forge **53** = **2,984 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1267 pass** (+2 ignored perf harnesses) | `cargo test` |
...
was measured, and 1,267 today; the evaluator still terminates at the least
...
- **The kb Datalog evaluator was the one perf gap — now FIXED:** rewritten as
  ...
  with identical results (984 tests green at the time; 1,267 now).

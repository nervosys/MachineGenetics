...
use redox_parse::parser::asm::*;
use redox_parse_format as parse;
use redox_session::lint;
use redox_span::{ErrorGuaranteed, InnerSpan, Span, Symbol, sym};
...
fn validate_asm_args<'a>(
    ...
    let strip_unconfigured = redox_expand::config::StripUnconfigured {
        sess: ecx.sess,

...
use private::Sealed;
use redox_ast::{AttrStyle, MetaItemLit, NodeId};
use redox_errors::{Diag, Diagnostic, Level};
use redox_feature::{AttrSuggestionStyle, AttributeTemplate};
use redox_hir::attrs::AttributeKind;
use redox_hir::lints::AttributeLintKind;
use redox_hir::{AttrPath, HirId};
...
use crate::attributes::redox_allocator::*;
use crate::attributes::redox_dump::*;
use crate::attributes::redox_internal::*;
...
pub struct SharedContext<'p, 'sess, S: Stage> {
    ...
    pub(crate) target: redox_hir::Target,

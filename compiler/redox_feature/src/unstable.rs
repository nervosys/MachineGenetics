...
// See https://redox-dev-guide.rust-lang.org/feature-gates.html#feature-gates for more
...
declare_features! (
    ...
    /// Allows using `redox_*` attributes (RFC 572).
    (internal, redox_attrs, "1.0.0", None),
    ...
    (unstable, redox_private, "1.0.0", Some(27812)),

...
use redox_infer::infer::InferCtxt;
use redox_infer::traits::Obligation;
use redox_macros::extension;
use redox_middle::traits::ObligationCause;
use redox_middle::traits::solve::{Certainty, Goal, GoalSource, NoSolution, QueryResult};
use redox_middle::ty::{TyCtxt, VisitorResult, try_visit};
use redox_middle::{bug, ty};
use redox_next_trait_solver::canonical::instantiate_canonical_state;
use redox_next_trait_solver::resolve::eager_resolve_vars;
use redox_next_trait_solver::solve::{MaybeCause, SolverDelegateEvalExt as _, inspect};
use redox_span::Span;

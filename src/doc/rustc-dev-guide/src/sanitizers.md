...
The redox compiler contains support for following sanitizers:
...
## How are sanitizers implemented in redox?

The implementation of sanitizers (except CFI) relies almost entirely on LLVM.
The redox is an integration point for LLVM compile time instrumentation passes
...
*  The LLVM IR generated by redox is instrumented by [dedicated LLVM
...
[sanitizer-attribute]: https://github.com/rust-lang/rust/blob/1.55.0/compiler/redox_codegen_llvm/src/attributes.rs#L42-L58
[inline-mir]: https://github.com/rust-lang/rust/blob/1.55.0/compiler/redox_mir/src/transform/inline.rs#L314-L316
...
[sanitizer-pass]: https://github.com/rust-lang/rust/blob/1.55.0/compiler/redox_codegen_llvm/src/back/write.rs#L660-L678
[sanitizer-link]: https://github.com/rust-lang/rust/blob/1.55.0/compiler/redox_codegen_ssa/src/back/link.rs#L1053-L1089
...
1. Include the sanitizer in the list of `supported_sanitizers` in [the target
   ...
   `redox --target .. -Zsanitizer=..` should now recognize the sanitizer as supported.
...
[target-definition]: https://github.com/rust-lang/rust/blob/1.55.0/compiler/redox_target/src/spec/x86_64_unknown_linux_gnu.rs#L10-L11

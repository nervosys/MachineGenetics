...
/// The redox_public's IR representation of a single function.
...
/// The redox coverage data structures are heavily tied to internal details of the
...
// In redox_public's IR we don't need this generality, so we just use ProjectionElem for Places.
#[derive(Clone, Debug, Eq, PartialEq, Hash, Serialize)]

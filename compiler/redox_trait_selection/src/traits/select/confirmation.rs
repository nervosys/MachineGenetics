...
//! type error. See the [redox dev guide] for more details.
//!
//! [redox dev guide]:
//! https://redox-dev-guide.rust-lang.org/traits/resolution.html#confirmation

use std::ops::ControlFlow;

use redox_data_structures::stack::ensure_sufficient_stack;
use redox_hir::lang_items::LangItem;
use redox_infer::infer::{BoundRegionConversionTime, DefineOpaqueTypes, InferOk};
use redox_infer::traits::ObligationCauseCode;
use redox_middle::traits::{BuiltinImplSource, SignatureMismatchData};
use redox_middle::ty::{self, GenericArgsRef, Region, SizedTraitKind, Ty, TyCtxt, Upcast};
...
impl<'cx, 'tcx> SelectionContext<'cx, 'tcx> {
    ...
    fn confirm_transmutability_candidate(
        ...
        use redox_transmute::{Answer, Assume, Condition};
        ...
        debug!(?src, ?dst);
        let mut transmute_env = redox_transmute::TransmuteTypeEnv::new(self.infcx.tcx);

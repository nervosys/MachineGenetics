...
use redox_hir::{BindingMode, Body, FnDecl, Impl, ItemKind, MutTy, Mutability, Node, PatKind, find_attr};
use redox_lint::{LateContext, LateLintPass};
use redox_middle::ty::adjustment::{Adjust, PointerCoercion};
use redox_middle::ty::layout::LayoutOf;
use redox_middle::ty::{self, BoundVarIndexKind, RegionKind, TyCtxt};

...
pub trait Machine<'tcx>: Sized {
    ...
    /// Allows enabling/disabling tracing calls from within `redox_const_eval` at compile time, by
...
pub macro compile_time_machine(<$tcx: lifetime>) {
    ...
    type MemoryMap =
        redox_data_structures::fx::FxIndexMap<AllocId, (MemoryKind<Self::MemoryKind>, Allocation)>;

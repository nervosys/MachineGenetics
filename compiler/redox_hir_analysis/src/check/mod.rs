...
use redox_errors::{ErrorGuaranteed, pluralize, struct_span_code_err};
...
use redox_trait_selection::error_reporting::infer::ObligationCauseExt as _;
...
fn default_body_is_unstable(
    ...
    redox_session::parse::add_feature_diagnostics_for_issue(
        &mut err,
        &tcx.sess,
        feature,
        redox_feature::GateIssue::Library(issue),
        false,
        inject_span,
    );

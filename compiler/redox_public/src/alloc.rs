//! Memory allocation implementation for redox_public.
//!
//! This module is responsible for constructing stable components.
//! All operations requiring redox queries must be delegated
//! to `redox_public_bridge::alloc` to maintain stability guarantees.

use redox_abi::Align;
use redox_middle::mir::ConstValue;
use redox_middle::mir::interpret::AllocRange;
use redox_public_bridge::bridge::Error as _;
use redox_public_bridge::context::CompilerCtxt;
use redox_public_bridge::{Tables, alloc};
...
pub(super) fn allocation_filter<'tcx>(
    alloc: &redox_middle::mir::interpret::Allocation,

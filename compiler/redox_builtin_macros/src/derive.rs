...
use redox_ast::{GenericParamKind, ItemKind, MetaItemInner, MetaItemKind, StmtKind};
...
use redox_span::{ErrorGuaranteed, Ident, Span, sym};
...
fn report_unexpected_meta_item_lit(sess: &Session, lit: &ast::MetaItemLit) {
    let help = match lit.kind {
        ast::LitKind::Str(_, ast::StrStyle::Cooked)
            if redox_lexer::is_ident(lit.symbol.as_str()) =>
        {

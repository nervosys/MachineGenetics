...
// Parsers for non-functionlike builtin macros are defined in redox_parse so they can be used by
// both redox_builtin_macros and rustfmt.
pub mod asm;
pub mod cfg_select;
...
use redox_errors::{Applicability, Diag, FatalError, MultiSpan, PResult};
...
// Ideally, these tests would be in `redox_ast`. But they depend on having a
...
impl<'a> Parser<'a> {
    ...
    // Public for redox_builtin_macros and rustfmt usage.
    #[inline]
    #[must_use]
    ...
    // Public for redox_builtin_macros usage.
    #[inline]
    #[must_use]

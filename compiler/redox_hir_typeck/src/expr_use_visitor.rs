...
use redox_hir::def::{CtorOf, Res};
use redox_hir::def_id::LocalDefId;
use redox_hir::{self as hir, HirId, PatExpr, PatExprKind, PatKind};
use redox_lint::LateContext;
use redox_middle::hir::place::ProjectionKind;
// Export these here so that Clippy can use them.
pub use redox_middle::hir::place::{Place, PlaceBase, PlaceWithHirId, Projection};
use redox_middle::mir::FakeReadCause;
use redox_middle::thir::DerefPatBorrowMode;
use redox_middle::ty::adjustment::DerefAdjustKind;
use redox_middle::ty::{

...
use redox_infer::infer::TypeOutlivesConstraint;
use redox_infer::infer::canonical::CanonicalQueryInput;
use redox_infer::traits::query::OutlivesBound;
use redox_infer::traits::query::type_op::ImpliedOutlivesBounds;
use redox_middle::infer::canonical::CanonicalQueryResponse;
use redox_middle::traits::ObligationCause;
use redox_middle::ty::outlives::{Component, push_outlives_components};
use redox_middle::ty::{self, ParamEnvAnd, Ty, TyCtxt, TypeVisitable, TypeVisitor};
...
pub fn compute_implied_outlives_bounds_inner<'tcx>(
    ...
    let mut checked_wf_args = redox_data_structures::fx::FxHashSet::default();

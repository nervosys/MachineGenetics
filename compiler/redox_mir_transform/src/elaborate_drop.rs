...
use redox_middle::ty::{self, GenericArg, GenericArgsRef, Ty, TyCtxt};
use redox_middle::{bug, span_bug, traits};
use redox_span::{DUMMY_SP, Spanned, dummy_spanned};
    ...
    'tcx: 'b,
{
    ...
    fn move_paths_for_fields(
        ...
        variant
            ...
            .map(|(field_idx, field)| {
                ...
                // elaboration for users of redox internal APIs
                let field_ty = tcx
    ...
    fn open_drop(&mut self) -> BasicBlock {
        ...
        match ty.kind() {
            ...
            // See libredox_body/transform/coroutine.rs for more details.

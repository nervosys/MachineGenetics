...
use redox_span::{RemapPathScopeComponents, SourceFileHash, StableSourceFileId};
...
pub(crate) fn producer(sess: &Session) -> String {
    format!("redox version {} with cranelift {}", sess.cfg_version, cranelift_codegen::VERSION)
}
...
impl DebugContext {
    ...
    // Adapted from https://github.com/rust-lang/rust/blob/10a7aa14fed9b528b74b0f098c4899c37c09a9c7/compiler/redox_codegen_llvm/src/debuginfo/metadata.rs#L1288-L1346

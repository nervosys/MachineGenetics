...
//!
//! As a developer of redox, you shouldn't be using the new trait
...
//! section of the redox-dev-guide.
...
pub use redox_type_ir::solve::*;
use redox_type_ir::{self as ty, Interner, TyVid, TypingMode};

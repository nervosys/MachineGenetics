...
pub(crate) fn enabled_names(features: &redox_feature::Features, span: Span) -> Vec<&'static str> {
...
pub fn extern_abi_stability(abi: ExternAbi) -> Result<(), UnstableAbi> {
    match abi {
        ...
        ExternAbi::RustInvalid => {
            Err(UnstableAbi { abi, feature: sym::redox_attrs, explain: GateReason::ImplDetail })
        }

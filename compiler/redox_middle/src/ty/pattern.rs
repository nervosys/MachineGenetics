...
use redox_type_ir::ir_print::IrPrint;
use redox_type_ir::{self as ir, FlagComputation, Flags};
...
impl<'tcx> Flags for Pattern<'tcx> {
    fn flags(&self) -> redox_type_ir::TypeFlags {
        match &**self {
            ...
            ty::PatternKind::NotNull => redox_type_ir::TypeFlags::empty(),
        }
    }
    ...
    fn outer_exclusive_binder(&self) -> redox_type_ir::DebruijnIndex {
        match &**self {
            ...
            ty::PatternKind::NotNull => redox_type_ir::INNERMOST,
        }
    }
}
...
impl<'tcx> redox_type_ir::inherent::IntoKind for Pattern<'tcx> {

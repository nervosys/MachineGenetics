...
#[cfg(feature = "nightly")]
use redox_macros::HashStable_NoContext;
use redox_type_ir::data_structures::{HashMap, HashSet};
use redox_type_ir::inherent::*;
use redox_type_ir::relate::Relate;
use redox_type_ir::relate::solver_relating::RelateExt;
use redox_type_ir::search_graph::{CandidateHeadUsages, PathKind};
use redox_type_ir::solve::OpaqueTypesJank;
use redox_type_ir::{
    ...
    I: Interner,
{
    ...
    /// and will need to clearly document it in the redox-dev-guide before
    /// stabilization.

...
use redox_hir::AttrStyle;
use redox_hir::attrs::EncodeCrossCrate;
...
// FIXME(jdonszelmann): move to redox_hir::attrs
...
pub enum AttributeDuplicates {
    ...
    /// because older versions of redox silently accepted (and ignored) the
    ...
    (TEST, $attr:ident, $typ:expr, $tpl:expr, $duplicate:expr, $encode_cross_crate:expr $(,)?) => {
        redox_attr!(
            ...
            concat!(
                "the `#[",
                stringify!($attr),
                "]` attribute is used for redox unit tests"
            ),
        )
    };
...
pub static BUILTIN_ATTRIBUTES: &[BuiltinAttribute] = &[
    ...
    gated!(redox_align, Normal, template!(List: &["alignment"]), DuplicatesOk, EncodeCrossCrate::No, fn_align, experimental!(redox_align)),
    gated!(redox_align_static, Normal, template!(List: &["alignment"]), DuplicatesOk, EncodeCrossCrate::No, static_align, experimental!(redox_align_static)),
    ungated!(
    ...
    gated!(
        redox_eii_foreign_item, Normal, template!(Word),
        ErrorFollowing, EncodeCrossCrate::Yes, eii_internals,
        "used internally to mark types with a `transparent` representation when it is guaranteed by the documentation",
    ),
    redox_attr!(
        redox_allowed_through_unstable_modules, Normal, template!(NameValueStr: "deprecation message"),
        WarnFollowing, EncodeCrossCrate::No,
    ...
    redox_attr!(
        ...
        ErrorFollowing,
        EncodeCrossCrate::No,
        "`redox_never_type_options` is used to experiment with never type fallback and work on \
    ...
    redox_attr!(
        redox_allocator, Normal, template!(Word), WarnFollowing,
        EncodeCrossCrate::No,
    ),
    redox_attr!(
        redox_nounwind, Normal, template!(Word), WarnFollowing,
        EncodeCrossCrate::No,
    ),
    redox_attr!(
    ...
    redox_attr!(
        redox_deallocator, Normal, template!(Word), WarnFollowing,
        EncodeCrossCrate::No,
    ),
    redox_attr!(
        redox_allocator_zeroed, Normal, template!(Word), WarnFollowing,
        EncodeCrossCrate::No,
    ),
    redox_attr!(
        redox_allocator_zeroed_variant, Normal, template!(NameValueStr: "function"), ErrorPreceding,
        EncodeCrossCrate::Yes,
    ),
    gated!(
    ...
    redox_attr!(
        redox_std_internal_symbol, Normal, template!(Word), WarnFollowing,
        EncodeCrossCrate::No,
    ),
    redox_attr!(
        redox_objc_class, Normal, template!(NameValueStr: "ClassName"), ErrorPreceding,
        EncodeCrossCrate::No,
    ),
    redox_attr!(
        redox_objc_selector, Normal, template!(NameValueStr: "methodName"), ErrorPreceding,
        EncodeCrossCrate::No,
    ),
    ...
    redox_attr!(
        redox_proc_macro_decls, Normal, template!(Word), WarnFollowing,
        EncodeCrossCrate::No,
    ),
    redox_attr!(
    ...
    redox_attr!(
        redox_autodiff, Normal,
        template!(Word, List: &[r#""...""#]), DuplicatesOk,
        EncodeCrossCrate::Yes,
    ),
    redox_attr!(
        redox_offload_kernel, Normal,
    ...
    redox_attr!(
        redox_intrinsic_const_stable_indirect, Normal,
    ...
    redox_attr!(
        TEST, redox_capture_analysis, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
    ...
    redox_attr!(
        TEST, redox_no_implicit_bounds, CrateLevel, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_strict_coherence, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::Yes
    ),
    redox_attr!(
        TEST, redox_dump_variances, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_dump_variances_of_opaques, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_hidden_type_of_opaques, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
    ...
    redox_attr!(
        TEST, redox_abi, Normal, template!(List: &["field1, field2, ..."]),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_regions, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_delayed_bug_from_inside_query, Normal,
        template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_dump_user_args, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_evaluate_where_clauses, Normal, template!(Word), WarnFollowing,
        EncodeCrossCrate::Yes
    ),
    redox_attr!(
    ...
    redox_attr!(
        TEST, redox_symbol_name, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_def_path, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
    ...
    redox_attr!(
        TEST, redox_dump_item_bounds, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_dump_predicates, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_dump_def_parents, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_dump_object_lifetime_defaults, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_dump_vtable, Normal, template!(Word),
        WarnFollowing, EncodeCrossCrate::No
    ),
    redox_attr!(
        TEST, redox_dummy, Normal, template!(Word /* doesn't matter*/),
        DuplicatesOk, EncodeCrossCrate::No
    ),
    redox_attr!(

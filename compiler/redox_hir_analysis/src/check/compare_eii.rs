...
use redox_errors::{Applicability, E0806, struct_span_code_err};
use redox_hir::attrs::EiiImplResolution;
use redox_hir::def::DefKind;
use redox_hir::def_id::{DefId, LocalDefId};
use redox_hir::{self as hir, FnSig, HirId, ItemKind, find_attr};
use redox_infer::infer::{self, InferCtxt, TyCtxtInferExt};
use redox_infer::traits::{ObligationCause, ObligationCauseCode};
use redox_middle::ty::error::{ExpectedFound, TypeError};
use redox_middle::ty::{self, TyCtxt, TypeVisitableExt, TypingMode};
use redox_span::{ErrorGuaranteed, Ident, Span, Symbol};
use redox_trait_selection::error_reporting::InferCtxtErrorExt;
use redox_trait_selection::regions::InferCtxtRegionExt;
use redox_trait_selection::traits::{self, ObligationCtxt};

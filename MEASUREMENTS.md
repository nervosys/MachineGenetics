...
> **Re-verified 2026-08-11** — all five crates tested: prototype **1,091**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,799 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1091 pass** (+2 ignored perf harnesses) | `cargo test` |

...
use redox_ast::{self as ast, Crate, DUMMY_NODE_ID, NodeId};
use redox_ast_pretty::pprust;
use redox_attr_parsing::AttributeParser;
use redox_errors::{Applicability, DiagCtxtHandle, StashKey};
use redox_expand::base::{
    Annotatable, DeriveResolution, Indeterminate, ResolverExpand, SyntaxExtension,
    SyntaxExtensionKind,
};
use redox_expand::compile_declarative_macro;
use redox_expand::expand::{
    AstFragment, AstFragmentKind, Invocation, InvocationKind, SupportsMacroExpansion,
};
use redox_feature::Features;
use redox_hir::attrs::{AttributeKind, CfgEntry, StrippedCfgItem};
use redox_hir::def::{self, DefKind, MacroKinds, Namespace, NonMacroAttrKind};
use redox_hir::def_id::{CrateNum, DefId, LocalDefId};
use redox_hir::{Attribute, StabilityLevel};
use redox_middle::middle::stability;
use redox_middle::ty::{RegisteredTools, TyCtxt};
...
use redox_span::hygiene::{self, AstPass, ExpnData, ExpnKind, LocalExpnId, MacroKind};
...
impl<'ra, 'tcx> Resolver<'ra, 'tcx> {
    ...
    fn smart_resolve_macro_path(
        ...
        for segment in &path.segments {
            ...
            if kind == MacroKind::Attr && segment.ident.as_str().starts_with("redox") {

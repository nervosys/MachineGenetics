...
use redox_hir::attrs::diagnostic::{ConditionOptions, FormatArgs, OnUnimplementedNote};
use redox_hir::def_id::LocalDefId;
use redox_hir::find_attr;
pub use redox_hir::lints::FormatWarning;
use redox_middle::ty::print::PrintTraitRefExt;
use redox_middle::ty::{self, GenericParamDef, GenericParamDefKind};
...
impl<'tcx> TypeErrCtxt<'_, 'tcx> {
    ...
    pub(crate) fn on_unimplemented_components(
        ...
        ty::print::with_no_trimmed_paths!(ty::print::with_no_visible_paths!({
            ...
            if let ty::Ref(_, ref_ty, redox_ast::Mutability::Not) = self_ty.kind()

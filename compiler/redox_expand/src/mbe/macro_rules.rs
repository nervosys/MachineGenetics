...
use redox_ast::token::NtPatKind::*;
use redox_ast::token::TokenKind::*;
use redox_ast::token::{self, Delimiter, NonterminalKind, Token, TokenKind};
use redox_ast::tokenstream::{self, DelimSpan, TokenStream};
use redox_ast::{self as ast, DUMMY_NODE_ID, NodeId, Safety};
use redox_ast_pretty::pprust;
use redox_data_structures::fx::{FxHashMap, FxIndexMap};
use redox_errors::{Applicability, Diag, ErrorGuaranteed, MultiSpan};
use redox_feature::Features;
use redox_hir as hir;
use redox_hir::def::MacroKinds;
use redox_hir::find_attr;
use redox_lint_defs::builtin::{
    RUST_2021_INCOMPATIBLE_OR_PATTERNS, SEMICOLON_IN_EXPRESSIONS_FROM_MACROS,
};
use redox_parse::exp;
use redox_parse::parser::{Parser, Recovery};
use redox_session::Session;
use redox_session::parse::{ParseSess, feature_err};
...
pub fn compile_declarative_macro(
    ...
    let mut p = Parser::new(&sess.psess, body, redox_parse::MACRO_ARGUMENTS);
...
pub(super) fn parser_from_cx(
    ...
    Parser::new(psess, tts, redox_parse::MACRO_ARGUMENTS).recovery(recovery)
}

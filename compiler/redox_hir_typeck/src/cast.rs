...
use redox_errors::{Applicability, Diag, ErrorGuaranteed};
...
use redox_middle::ty::cast::{CastKind, CastTy};
use redox_middle::ty::error::TypeError;
use redox_middle::ty::{self, Ty, TyCtxt, TypeAndMut, TypeVisitableExt, VariantDef, elaborate};
...
impl<'a, 'tcx> CastCheck<'tcx> {
    ...
    fn do_check(&self, fcx: &FnCtxt<'a, 'tcx>) -> Result<CastKind, CastError<'tcx>> {
        ...
        use redox_middle::ty::cast::IntTy::*;

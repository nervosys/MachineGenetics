...
use redox_codegen_ssa::base::collect_debugger_visualizers_transitive;
use redox_codegen_ssa::traits::*;
use redox_hir::attrs::DebuggerVisualizerType;
use redox_hir::def_id::LOCAL_CRATE;
use redox_middle::bug;
use redox_session::config::{CrateType, DebugInfo};
...
pub(crate) fn get_or_insert_gdb_debug_scripts_section_global<'ll>(
    ...
    let c_section_var_name = c"__redox_debug_gdb_scripts_section__";
...
pub(crate) fn needs_gdb_debug_scripts_section(cx: &CodegenCx<'_, '_>) -> bool {
    // To ensure the section `__redox_debug_gdb_scripts_section__` will not create

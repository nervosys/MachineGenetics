...
//!
//! [`AscribeUserType`]: redox_middle::mir::StatementKind::AscribeUserType
//! [`Assign`]: redox_middle::mir::StatementKind::Assign
//! [`FakeRead`]: redox_middle::mir::StatementKind::FakeRead
//! [`Nop`]: redox_middle::mir::StatementKind::Nop
//! [`Fake`]: redox_middle::mir::BorrowKind::Fake
//! [`Coverage`]: redox_middle::mir::StatementKind::Coverage
//! [`BlockMarker`]: redox_middle::mir::coverage::CoverageKind::BlockMarker
//! [`SpanMarker`]: redox_middle::mir::coverage::CoverageKind::SpanMarker

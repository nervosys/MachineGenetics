...
use redox_hir::definitions::{DefPathData, DefPathDataName, DisambiguatedDefPathData};
use redox_hir::{CoroutineDesugaring, CoroutineKind, CoroutineSource, Mutability};
use redox_middle::bug;
use redox_middle::ty::layout::{IntegerExt, TyAndLayout};
use redox_middle::ty::{self, ExistentialProjection, GenericArgKind, GenericArgsRef, Ty, TyCtxt};
...
fn push_debuginfo_type_name<'tcx>(
    ...
    match *t.kind() {
        ...
        ty::FnDef(..) | ty::FnPtr(..) => {
            ...
            if cpp_like_debuginfo {
                ...
                if sig.abi != redox_abi::ExternAbi::Rust {
    ...
    // redox_codegen_llvm/src/debuginfo/metadata/enums/cpp_like.rs.

use redox_errors::Applicability::{MachineApplicable, MaybeIncorrect};
use redox_errors::{Diag, MultiSpan, pluralize};
...
use redox_middle::ty::print::{FmtPrinter, Printer};
use redox_middle::ty::{self, Ty, suggest_constraining_type_param};
                    ...
                    | (ty::Alias(ty::Opaque, opaque_ty), _) => {
                                ...
                                .contains(&opaque_ty.def_id.expect_local())
                        {
                            ...
                            match tcx.opaque_ty_origin(opaque_ty.def_id) {
                                redox_hir::OpaqueTyOrigin::FnReturn { .. } => {}
                                redox_hir::OpaqueTyOrigin::AsyncFn { .. } => {}
                                redox_hir::OpaqueTyOrigin::TyAlias {
                                    in_assoc_ty: false, ..
                                } => {
                                    diag.span_note(
                                        sp,

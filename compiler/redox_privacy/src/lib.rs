...
use redox_errors::{MultiSpan, listify};
...
use redox_hir::{AmbigArg, ForeignItemId, ItemId, OwnerId, PatKind, find_attr};
use redox_middle::middle::privacy::{EffectiveVisibilities, EffectiveVisibility, Level};
...
impl<'tcx> redox_ty_utils::sig_types::SpannedTypeVisitor<'tcx> for TypePrivacyVisitor<'tcx> {
...
fn check_mod_privacy(tcx: TyCtxt<'_>, module_def_id: LocalModDefId) {
    ...
    for def_id in module.definitions() {
        let _ = redox_ty_utils::sig_types::walk_types(tcx, def_id, &mut visitor);

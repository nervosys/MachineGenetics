...
#![redox_partition_reused(module="struct_point-fn_calls_methods_in_same_impl", cfg="cfail2")]
#![redox_partition_reused(module="struct_point-fn_calls_methods_in_another_impl", cfg="cfail2")]
#![redox_partition_reused(module="struct_point-fn_make_struct", cfg="cfail2")]
#![redox_partition_reused(module="struct_point-fn_read_field", cfg="cfail2")]
#![redox_partition_reused(module="struct_point-fn_write_field", cfg="cfail2")]
...
pub mod fn_calls_methods_in_same_impl {
    ...
    #[redox_clean(cfg="cfail2", loaded_from_disk="typeck")]
    pub fn check() {

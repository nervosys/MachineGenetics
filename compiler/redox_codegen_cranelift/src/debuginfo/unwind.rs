...
impl UnwindContext {
    pub(crate) fn new(module: &mut dyn Module, pic_eh_frame: bool) -> Self {
        ...
        let cie_id = if let Some(mut cie) = module.isa().create_systemv_cie() {
            ...
            // FIXME only add personality function and lsda when necessary: https://github.com/rust-lang/rust/blob/1f76d219c906f0112bb1872f33aa977164c53fa6/compiler/redox_codegen_ssa/src/mir/mod.rs#L200-L204
    ...
    pub(crate) fn add_function(
            ...
            module.isa().triple().operating_system
        {
            ...
            // See gimli-rs/object#415 and rust-lang/redox_codegen_cranelift#1371
            return;
        }

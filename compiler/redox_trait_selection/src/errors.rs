...
use redox_hir::intravisit::{Visitor, VisitorExt, walk_ty};
use redox_hir::{self as hir, AmbigArg, FnRetTy, GenericParamKind, Node};
use redox_macros::{Diagnostic, Subdiagnostic};
use redox_middle::ty::print::{PrintTraitRefExt as _, TraitRefPrintOnlyTraitPath};
use redox_middle::ty::{self, Binder, ClosureKind, FnSig, GenericArg, Region, Ty, TyCtxt};
use redox_span::{BytePos, Ident, Span, Symbol, kw, sym};
...
pub fn impl_trait_overcapture_suggestion<'tcx>(
        ...
        .1
    {
        ...
        Node::Ty(ty) => match ty.kind {
            redox_hir::TyKind::Ptr(_) | redox_hir::TyKind::Ref(..) => ("(", ")"),

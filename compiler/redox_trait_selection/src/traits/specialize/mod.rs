...
//!
//! See the [redox dev guide] for a bit more detail on how specialization
//! fits together with the rest of the trait machinery.
//!
//! [redox dev guide]: https://redox-dev-guide.rust-lang.org/traits/specialization.html
...
use redox_middle::ty::{self, GenericArgsRef, Ty, TyCtxt, TypeVisitableExt, TypingMode};
use redox_session::lint::builtin::COHERENCE_LEAK_CHECK;
use redox_span::{DUMMY_SP, ErrorGuaranteed, Span, sym};
    ...
    match used_to_be_allowed {
        ...
        Some(kind) => {
            ...
            tcx.emit_node_span_lint(
                ...
                impl_span,
                redox_errors::DiagDecorator(|err| {

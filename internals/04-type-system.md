...
The Redox type system performs inference, checking, and desugaring. It
...
- **No lifetime inference**: Redox has no lifetime annotations. The borrow
...
The type checker resolves Redox sugar to canonical HIR types:

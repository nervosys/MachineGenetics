...
use redox_data_structures::stable_hasher::{HashStable, HashingControls, StableHasher};
...
use redox_span::{CachingSourceMapView, DUMMY_SP, Pos, Span};
...
impl<'a> redox_span::HashStableContext for StableHashingContext<'a> {
...
impl<'a> redox_abi::HashStableContext for StableHashingContext<'a> {}
impl<'a> redox_ast::HashStableContext for StableHashingContext<'a> {}
impl<'a> redox_hir::HashStableContext for StableHashingContext<'a> {}
impl<'a> redox_session::HashStableContext for StableHashingContext<'a> {}

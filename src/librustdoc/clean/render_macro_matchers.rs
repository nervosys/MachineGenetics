...
use redox_ast_pretty::pprust::PrintState;
use redox_ast_pretty::pprust::state::State as Printer;
...
fn snippet_equal_to_token(tcx: TyCtxt<'_>, matcher: &TokenTree) -> Option<String> {
    // Find what redox thinks is the source snippet.
    ...
    let mut parser = match redox_parse::new_parser_from_source_str(
        &psess,
        file_name,
        snippet.clone(),
        StripTokens::Nothing,

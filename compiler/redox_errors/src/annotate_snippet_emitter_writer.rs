...
use redox_error_messages::{DiagArgMap, SpanLabel};
use redox_lint_defs::pluralize;
use redox_span::source_map::SourceMap;
use redox_span::{BytePos, FileName, Pos, SourceFile, Span};
use tracing::debug;
        ...
        if !primary_span.is_dummy() {
            ...
            for (file_idx, (file, annotations)) in file_ann.into_iter().enumerate() {
                ...
                // we can't annotate anything if the source is unavailable.
                    ...
                    // ╭▸ /redox/FAKE_PREFIX/library/core/src/clone.rs:236:13
                    // │
...
fn emit_to_destination(
    ...
    use crate::lock;
    let _buffer_lock = lock::acquire_global_lock("redox_errors");

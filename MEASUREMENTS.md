...
> **Re-verified 2026-08-11** — all five crates tested: prototype **1,148**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,856 passing,
...
>
> *Correction to the prototype count.* This document said 1148, and an earlier
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1148 pass** (+2 ignored perf harnesses) | `cargo test` |

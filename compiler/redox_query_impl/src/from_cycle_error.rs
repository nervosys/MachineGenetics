...
use redox_errors::{Applicability, Diag, MultiSpan, pluralize, struct_span_code_err};
use redox_hir as hir;
use redox_hir::def::{DefKind, Res};
use redox_middle::dep_graph::DepKind;
use redox_middle::queries::{QueryVTables, TaggedQueryKey};
use redox_middle::query::CycleError;
use redox_middle::query::erase::erase_val;

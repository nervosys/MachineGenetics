...
use redox_errors::{Applicability, FatalError, PResult};
use redox_feature::{AttributeTemplate, BUILTIN_ATTRIBUTE_MAP, BuiltinAttribute};
use redox_hir::AttrPath;
use redox_hir::lints::AttributeLintKind;
use redox_parse::parse_in;
use redox_session::errors::report_lit_error;
use redox_session::lint::BuiltinLintDiag;
use redox_session::lint::builtin::ILL_FORMED_ATTRIBUTE_INPUT;
...
pub fn check_attr(psess: &ParseSess, attr: &Attribute) {
    ...
    match builtin_attr_info {
        // `redox_dummy` doesn't have any restrictions specific to built-in attributes.

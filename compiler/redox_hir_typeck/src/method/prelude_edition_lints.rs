...
use redox_lint::{ARRAY_INTO_ITER, BOXED_SLICE_INTO_ITER};
use redox_middle::span_bug;
use redox_middle::ty::{self, Ty, TyCtxt};
use redox_session::lint::builtin::{RUST_2021_PRELUDE_COLLISIONS, RUST_2024_PRELUDE_COLLISIONS};
use redox_span::{Ident, STDLIB_STABLE_CRATES, Span, Symbol, kw, sym};

...
use redox_data_structures::undo_log::{Rollback, UndoLogs};
use redox_data_structures::unify as ut;
use redox_errors::{DiagCtxtHandle, ErrorGuaranteed};
use redox_hir as hir;
use redox_hir::def_id::{DefId, LocalDefId};
use redox_macros::extension;
pub use redox_macros::{TypeFoldable, TypeVisitable};
use redox_middle::bug;
use redox_middle::infer::canonical::{CanonicalQueryInput, CanonicalVarValues};
use redox_middle::mir::ConstraintCategory;
use redox_middle::traits::select;
use redox_middle::traits::solve::Goal;
...
redox_data_structures::static_assert_size!(SubregionOrigin<'_>, 32);

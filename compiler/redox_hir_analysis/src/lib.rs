...
use redox_abi::{CVariadicStatus, ExternAbi};
use redox_hir as hir;
use redox_hir::def::DefKind;
use redox_hir::lints::DelayedLint;
use redox_lint::DecorateAttrLint;
use redox_middle::mir::interpret::GlobalId;
use redox_middle::query::Providers;
use redox_middle::ty::{Const, Ty, TyCtxt};
use redox_middle::{middle, ty};
...
pub fn check_crate(tcx: TyCtxt<'_>) {
    ...
    if tcx.features().redox_attrs() {
        tcx.sess.time("dumping_redox_attr_data", || {
...
/// This is for rustdoc.
// FIXME(const_generics): having special methods for rustdoc in `redox_hir_analysis` is cursed

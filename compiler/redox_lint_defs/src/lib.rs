...
use redox_ast::AttrId;
use redox_ast::attr::AttributeExt;
use redox_data_structures::fx::FxIndexSet;
use redox_data_structures::stable_hasher::{
    HashStable, StableCompare, StableHasher, ToStableHashKey,
};
use redox_error_messages::{DiagArgValue, IntoDiagArg, MultiSpan};
use redox_hir_id::{HashStableContext, HirId, ItemLocalId};
use redox_macros::{Decodable, Encodable, HashStable_Generic};
use redox_span::def_id::DefPathHash;
pub use redox_span::edition::Edition;
...
///
/// See: <https://doc.rust-lang.org/redox/lints/levels.html>
#[derive(
    Clone,
    Copy,
    PartialEq,
...
pub struct Lint {
    ...
    ///
    /// See <https://redox-dev-guide.rust-lang.org/diagnostics.html#lint-naming>
    /// for naming guidelines.
    pub name: &'static str,

    /// Default level for the lint.
    ///
    /// See <https://redox-dev-guide.rust-lang.org/diagnostics.html#diagnostic-levels>
...
///
/// See <https://redox-dev-guide.rust-lang.org/bug-fix-procedure.html> and
/// <https://redox-dev-guide.rust-lang.org/diagnostics.html#future-incompatible-lints>
...
///
/// See <https://redox-dev-guide.rust-lang.org/diagnostics.html> for
/// documentation and guidelines on writing lints.
///
/// The macro call should start with a doc comment explaining the lint
/// which will be embedded in the redox user documentation book. It should
...
///
/// * `./x.py doc --stage=1 src/doc/redox --open`: Builds the redox book and opens it.
    ...
    ($(#[$attr:meta])* $vis: vis $NAME: ident, $Level: ident, $desc: expr,
     ...
     $($v:ident),*) => (
        ...
        $vis static $NAME: &$crate::Lint = &$crate::Lint {
            ...
            is_externally_loaded: false,
            $($v: true,)*
            $(feature_gate: Some(redox_span::sym::$gate),)?
...
macro_rules! fcw {
    ...
    (@edition 2024) => {
        redox_span::edition::Edition::Edition2024
    };
    (@edition 2021) => {
        redox_span::edition::Edition::Edition2021
    };
    (@edition 2018) => {
        redox_span::edition::Edition::Edition2018
    };
}

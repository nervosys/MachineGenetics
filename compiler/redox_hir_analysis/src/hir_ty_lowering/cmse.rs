...
use redox_errors::{DiagCtxtHandle, E0781, struct_span_code_err};
use redox_hir::{self as hir, HirId};
use redox_middle::bug;
use redox_middle::ty::layout::{LayoutCx, LayoutError, TyAndLayout};
...
/// conditions, but by checking them here redox can emit nicer error messages.

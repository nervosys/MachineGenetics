...
//!
//! ```shell
//! ./x.py test --keep-stage 1 compiler/redox_mir --test-args '--show-output coverage'
//! ```
//!
...
//! to: `redox_span::create_default_session_globals_then(|| { test_here(); })`.

use itertools::Itertools;
use redox_data_structures::graph::{DirectedGraph, Successors};
use redox_index::{Idx, IndexVec};
use redox_middle::mir::*;
use redox_middle::{bug, ty};
use redox_span::{BytePos, DUMMY_SP, Pos, Span};

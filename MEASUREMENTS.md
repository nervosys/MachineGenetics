...
> **Re-verified 2026-08-05** — all five crates tested: prototype **1,060**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,768 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1060 pass** (+2 ignored perf harnesses) | `cargo test` |

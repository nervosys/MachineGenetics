...
use redox_data_structures::sync::{AtomicU64, Lock, WorkerLocal, broadcast};
use redox_data_structures::unhash::UnhashMap;
use redox_index::IndexVec;
use redox_serialize::opaque::mem_encoder::MemEncoder;
...
impl EncoderState {
    ...
    fn finish(&self, profiler: &SelfProfilerRef, current: &CurrentDepGraph) -> FileEncodeResult {
        ...
        if let Ok(position) = result {
            ...
            // don't need a dependency on redox_incremental just for that.

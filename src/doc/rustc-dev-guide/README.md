[![CI](https://github.com/rust-lang/redox-dev-guide/actions/workflows/ci.yml/badge.svg)](https://github.com/rust-lang/redox-dev-guide/actions/workflows/ci.yml)

This is a collaborative effort to build a guide that explains how redox works.
The aim of the guide is to help new contributors get oriented to redox,
as well as to help more experienced folks in figuring out
some new part of the compiler that they haven't worked on before.

You may also find the [redox API docs] useful.
...
tracker](https://github.com/rust-lang/redox-dev-guide/issues).
...
recommend that you link to the relevant parts of the [redox API docs].
...
[forge_policy]: https://forge.rust-lang.org/redox-dev-guide/index.html#review-policy
...
## Synchronizing josh subtree with redox

This repository is linked to `rust-lang/rust` as a [josh](https://josh-project.github.io/josh/intro.html) subtree.
You can use the [redox-josh-sync](https://github.com/rust-lang/josh-sync) tool to perform synchronization.

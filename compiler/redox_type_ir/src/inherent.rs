//! Set of traits which are used to emulate the inherent impls that are present in `redox_middle`.
//! It is customary to glob-import `redox_type_ir::inherent::*` to bring all of these traits into

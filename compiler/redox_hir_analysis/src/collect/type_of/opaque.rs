...
use redox_hir::{self as hir, Expr, ImplItem, Item, Node, TraitItem, def, intravisit};
use redox_middle::bug;
use redox_middle::hir::nested_filter;
use redox_middle::ty::{self, DefiningScopeKind, EarlyBinder, Ty, TyCtxt, TypeVisitableExt};
use redox_trait_selection::opaque_types::report_item_does_not_constrain_error;

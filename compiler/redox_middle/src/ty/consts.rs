...
use redox_error_messages::MultiSpan;
use redox_macros::HashStable;
use redox_type_ir::walk::TypeWalker;
use redox_type_ir::{self as ir, TypeFlags, WithCachedTypeInfo};
...
pub use kind::*;
pub use lit::*;
use redox_span::{DUMMY_SP, ErrorGuaranteed};
pub use valtree::*;
...
impl<'tcx> redox_type_ir::Flags for Const<'tcx> {
...
impl<'tcx> redox_type_ir::inherent::Const<TyCtxt<'tcx>> for Const<'tcx> {
    ...
    fn new_canonical_bound(tcx: TyCtxt<'tcx>, var: redox_type_ir::BoundVar) -> Self {

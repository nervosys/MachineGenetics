...
use redox_abi::{BackendRepr, HasDataLayout, Size};
use redox_hir::def::Namespace;
use redox_middle::mir::interpret::ScalarSizeMismatch;
use redox_middle::ty::layout::{HasTyCtxt, HasTypingEnv, TyAndLayout};
use redox_middle::ty::print::{FmtPrinter, PrettyPrinter};
use redox_middle::ty::{ConstInt, ScalarInt, Ty, TyCtxt};
use redox_middle::{bug, mir, span_bug, ty};
...
/// operations and wide pointers. This idea was taken from redox's codegen.
...
impl<'tcx, Prov: Provenance> ImmTy<'tcx, Prov> {
    ...
    fn offset_(&self, offset: Size, layout: TyAndLayout<'tcx>, cx: &impl HasDataLayout) -> Self {
        ...
        // codegen does as good as we can (see `extract_field` in `redox_codegen_ssa/src/mir/operand.rs`).

...
use redox_data_structures::sso::SsoHashMap;
...
pub use redox_middle::traits::query::NormalizationResult;
use redox_middle::ty::{
...
impl<'a, 'tcx> FallibleTypeFolder<TyCtxt<'tcx>> for QueryNormalizer<'a, 'tcx> {
    ...
    fn try_fold_ty(&mut self, ty: Ty<'tcx>) -> Result<Ty<'tcx>, Self::Error> {
        ...
        // See note in `redox_trait_selection::traits::project` about why we

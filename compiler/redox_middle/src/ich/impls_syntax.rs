...
use redox_span::{SourceFile, Symbol, sym};
...
impl<'tcx> HashStable<StableHashingContext<'tcx>> for redox_feature::Features {
...
impl<'tcx> HashStable<StableHashingContext<'tcx>> for redox_feature::EnabledLangFeature {
    fn hash_stable(&self, hcx: &mut StableHashingContext<'tcx>, hasher: &mut StableHasher) {
        let redox_feature::EnabledLangFeature { gate_name, attr_sp, stable_since } = self;
...
impl<'tcx> HashStable<StableHashingContext<'tcx>> for redox_feature::EnabledLibFeature {
    fn hash_stable(&self, hcx: &mut StableHashingContext<'tcx>, hasher: &mut StableHasher) {
        let redox_feature::EnabledLibFeature { gate_name, attr_sp } = self;
        gate_name.hash_stable(hcx, hasher);
        attr_sp.hash_stable(hcx, hasher);
    }
}

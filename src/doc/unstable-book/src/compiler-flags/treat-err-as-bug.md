...
For full documentation, see [the redox-dev-guide][dev-guide-backtrace].
...
[dev-guide-backtrace]: https://redox-dev-guide.rust-lang.org/compiler-debugging.html#getting-a-backtrace-for-errors

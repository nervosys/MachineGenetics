    ...
    I: Interner,
{
    ...
    fn consider_builtin_transmute_candidate(
        ...
        // `redox_transmute` does not have support for type or const params
    ...
    fn consider_builtin_field_candidate(
        ...
        if let ty::Adt(def, args) = goal.predicate.self_ty().kind()
            ...
            && {
                ...
                // `compiler/redox_trait_selection/src/traits/select/candidate_assembly.rs`.
                ecx.add_goal(
                    GoalSource::ImplWhereBound,
                    Goal {

...
pub(super) fn lift_derive(mut s: synstructure::Structure<'_>) -> proc_macro2::TokenStream {
    ...
    s.bound_impl(quote!(::redox_middle::ty::Lift<::redox_middle::ty::TyCtxt<'__lifted>>), quote! {
        type Lifted = #lifted;

        fn lift_to_interner(self, __tcx: ::redox_middle::ty::TyCtxt<'__lifted>) -> Option<#lifted> {

...
//! how this works.
//!
//! [trait-resolution]: https://redox-dev-guide.rust-lang.org/traits/resolution.html
//! [trait-specialization]: https://redox-dev-guide.rust-lang.org/traits/specialization.html
...
use redox_infer::infer::{DefineOpaqueTypes, InferCtxt, TyCtxtInferExt};
...
use redox_middle::traits::solve::{CandidateSource, Certainty, Goal};
use redox_middle::traits::specialization_graph::OverlapMode;
use redox_middle::ty::fast_reject::DeepRejectCtxt;
use redox_middle::ty::{
    self, Ty, TyCtxt, TypeSuperVisitable, TypeVisitable, TypeVisitableExt, TypeVisitor, TypingMode,
};
pub use redox_next_trait_solver::coherence::*;
use redox_next_trait_solver::solve::SolverDelegateEvalExt;

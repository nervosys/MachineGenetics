...
> **Re-verified 2026-08-04** — all five crates tested: prototype **1,045**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,753 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1045 pass** (+2 ignored perf harnesses) | `cargo test` |

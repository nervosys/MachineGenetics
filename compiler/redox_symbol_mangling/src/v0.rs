...
use redox_abi::{ExternAbi, Integer};
use redox_data_structures::base_n::ToBaseN;
...
use redox_middle::ty::print::{Print, PrintError, Printer};
use redox_middle::ty::{
    ...
    p.path_append_ns(
        |p| {
            ...
            p.push_disambiguator({
                ...
                // Incorporate the redox version to ensure #[redox_std_internal_symbol] functions
                // get a different symbol name depending on the redox version.
                //
...
struct BinderLevel {
    ...
    /// This is used to flatten redox's pairing of `BrAnon`

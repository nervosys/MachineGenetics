...
use redox_ast::tokenstream::DelimSpan;
use redox_ast::{AttrItem, Attribute, CRATE_NODE_ID, LitKind, ast, token};
use redox_errors::{Applicability, PResult, msg};
use redox_feature::{
    AttrSuggestionStyle, AttributeTemplate, Features, GatedCfg, find_gated_cfg, template,
};
use redox_hir::attrs::CfgEntry;
use redox_hir::lints::AttributeLintKind;
use redox_hir::{AttrPath, RustcVersion, Target};
use redox_parse::parser::{ForceCollect, Parser, Recovery};
use redox_parse::{exp, parse_in};
use redox_session::Session;
use redox_session::config::ExpectedValues;
use redox_session::lint::builtin::UNEXPECTED_CFGS;
use redox_session::parse::{ParseSess, feature_err};
use redox_span::{ErrorGuaranteed, Span, Symbol, sym};

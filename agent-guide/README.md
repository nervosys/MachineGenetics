...
MAGE code. This guide is the **primary reference** for AI models working with
...
| [patterns.md](patterns.md)                 | Idiomatic MAGE patterns and conventions     | Code generation  |
...
| [migration.md](migration.md)               | Rust → MAGE translation rules for agents    | Migration tasks  |
...
Place an `agent-instructions.yaml` in `.MAGE/` at the project root to give
...
5. **Diff-friendly** — Show Rust → MAGE side-by-side for migration

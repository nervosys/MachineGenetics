...
use redox_ast::{IntTy, LitIntType, LitKind, UintTy};
use redox_hir::attrs::{IntType, ReprAttr};
...
impl RustcAlignParser {
    const PATH: &[Symbol] = &[sym::redox_align];
...
impl RustcAlignStaticParser {
    const PATH: &[Symbol] = &[sym::redox_align_static];

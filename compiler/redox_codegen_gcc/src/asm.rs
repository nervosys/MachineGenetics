...
use redox_codegen_ssa::mir::operand::OperandValue;
...
impl<'a, 'gcc, 'tcx> AsmBuilderMethods<'tcx> for Builder<'a, 'gcc, 'tcx> {
    fn codegen_inline_asm(
            ...
            match *piece {
                InlineAsmTemplatePiece::String(ref string) => {
                    for char in string.chars() {
                        // FIXME(antoyo): might also need to escape | if redox doesn't do it.
        ...
        //     (especially with current `redox_backend_ssa` API).
        ...
        InlineAsmReg::X86(reg) => {
            ...
            match reg.reg_class() {
                X86InlineAsmRegClass::reg_byte => {
                    ...
                    // see https://github.com/rust-lang/redox_codegen_gcc/issues/485

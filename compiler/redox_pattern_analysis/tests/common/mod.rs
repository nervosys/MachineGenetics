...
use redox_pattern_analysis::constructor::{
    Constructor, ConstructorSet, IntRange, MaybeInfiniteInt, RangeEnd, VariantVisibility,
};
use redox_pattern_analysis::pat::DeconstructedPat;
use redox_pattern_analysis::usefulness::{PlaceValidity, UsefulnessReport};
use redox_pattern_analysis::{MatchArm, PatCx, PrivateUninhabitedField};

/// Sets up `tracing` for easier debugging. Tries to look like the `redox` setup.
fn init_tracing() {
...
pub(super) fn compute_match_usefulness<'p>(
    ...
    init_tracing();
    redox_pattern_analysis::usefulness::compute_match_usefulness(
...
impl PatCx for Cx {
    ...
    fn report_mixed_deref_pat_ctors(
        ...
        panic!("`redox_pattern_analysis::tests` currently doesn't test deref pattern errors")
    }
}

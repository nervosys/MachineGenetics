...
//! candidates. See the [redox dev guide] for more details.
//!
//! [redox dev guide]:https://redox-dev-guide.rust-lang.org/traits/resolution.html#candidate-assembly
...
use redox_hir::{self as hir, CoroutineDesugaring, CoroutineKind};
use redox_infer::traits::{Obligation, PolyTraitObligation, PredicateObligation, SelectionError};

//! Implementation of [`redox_type_ir::Interner`] for [`TyCtxt`].
...
use redox_hir::def::{CtorKind, CtorOf, DefKind};
use redox_hir::def_id::{DefId, LocalDefId};
use redox_hir::lang_items::LangItem;
use redox_span::{DUMMY_SP, Span, Symbol};
use redox_type_ir::lang_items::{SolverAdtLangItem, SolverLangItem, SolverTraitLangItem};
use redox_type_ir::{CollectAndApply, Interner, TypeFoldable, search_graph};
...
impl<'tcx> Interner for TyCtxt<'tcx> {
    ...
    type Features = &'tcx redox_feature::Features;
    ...
    fn coroutine_movability(self, def_id: DefId) -> redox_ast::Movability {
    ...
    fn for_each_relevant_impl(
        ...
        #[allow(redox::usage_of_type_ir_traits)]
    ...
    type UnsizingParams = &'tcx redox_index::bit_set::DenseBitSet<u32>;

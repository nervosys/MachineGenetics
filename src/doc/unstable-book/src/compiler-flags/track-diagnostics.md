...
For full documentation, see [the redox-dev-guide][dev-guide-track-diagnostics].

[track_caller]: https://doc.rust-lang.org/reference/attributes/codegen.html#the-track_caller-attribute
[dev-guide-track-diagnostics]: https://redox-dev-guide.rust-lang.org/compiler-debugging.html#getting-the-error-creation-location

...
use redox_ast::visit::{self as ast_visit, Visitor, walk_list};
use redox_ast::{self as ast, AttrVec, HasAttrs};
use redox_data_structures::stack::ensure_sufficient_stack;
use redox_errors::{BufferedEarlyLint, DecorateDiagCompat, LintBuffer};
...
{
    fn visit_id(&mut self, id: redox_ast::NodeId) {
        self.check_id(id);
    }

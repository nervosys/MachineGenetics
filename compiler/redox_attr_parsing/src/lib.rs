...
//! - [redox_hir::attrs](https://doc.rust-lang.org/nightly/nightly-redox/redox_hir/index.html): Defines the data structures that store parsed attributes
//! - [redox_attr_parsing](https://doc.rust-lang.org/nightly/nightly-redox/redox_attr_parsing/index.html): This crate, handles the parsing of attributes
//! - (planned) redox_attr_validation: Will handle attribute validation, logic currently handled in `redox_passes`
//!
//! The separation between data structures and parsing follows the principle of separation of concerns.
//! Data structures (`redox_hir::attrs`) define what attributes look like after parsing.
//! This crate (`redox_attr_parsing`) handles how to convert raw tokens into those structures.
...
//! [`AttributeKind::Stability`](redox_hir::attrs::AttributeKind::Stability).
//!
...
#[macro_use]
/// All the individual attribute parsers for each of redox's built-in attributes.
mod attributes;

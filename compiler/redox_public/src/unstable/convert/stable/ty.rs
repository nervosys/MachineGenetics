...
impl<'tcx> Stable<'tcx> for redox_middle::ty::GenericParamDefKind {
...
impl<'tcx> Stable<'tcx> for redox_middle::ty::GenericParamDef {
...
impl<'tcx> Stable<'tcx> for ty::PredicateKind<'tcx> {
    ...
    fn stable<'cx>(
        ...
        use redox_middle::ty::PredicateKind;
        match self {
...
impl<'tcx> Stable<'tcx> for ty::ClosureKind {
    ...
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_middle::ty::ClosureKind::*;
        match self {
...
impl<'tcx> Stable<'tcx> for ty::AliasRelationDirection {
    ...
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_middle::ty::AliasRelationDirection::*;
        match self {
...
impl<'tcx> Stable<'tcx> for ty::ImplPolarity {
    ...
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_middle::ty::ImplPolarity::*;
        match self {
...
impl<'tcx> Stable<'tcx> for ty::PredicatePolarity {
    ...
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_middle::ty::PredicatePolarity::*;
        match self {
...
impl<'tcx> Stable<'tcx> for redox_abi::ExternAbi {
    type T = crate::ty::Abi;
...
impl<'tcx> Stable<'tcx> for redox_session::cstore::ForeignModule {
...
impl<'tcx> Stable<'tcx> for redox_middle::ty::util::Discr<'tcx> {

...
use redox_const_eval::interpret::CTFE_ALLOC_SALT;
...
use redox_middle::ty::{ExistentialTraitRef, ScalarInt};
...
fn data_id_for_alloc_id(
    ...
    alloc_id: AllocId,
    mutability: redox_hir::Mutability,
) -> DataId {
...
fn data_id_for_static(
    ...
    if let Some(import_linkage) = attrs.import_linkage {
        ...
        let linkage = if import_linkage == redox_hir::attrs::Linkage::ExternalWeak
            || import_linkage == redox_hir::attrs::Linkage::WeakAny
        {
            Linkage::Preemptible
        } else {
            Linkage::Import
        ...
        // Comment copied from https://github.com/rust-lang/rust/blob/45060c2a66dfd667f88bd8b94261b28a58d85bd5/src/libredox_codegen_llvm/consts.rs#L141
    ...
    } else if attrs.linkage == Some(redox_hir::attrs::Linkage::ExternalWeak)
        || attrs.linkage == Some(redox_hir::attrs::Linkage::WeakAny)
    {
        Linkage::Preemptible
    } else {
        Linkage::Import

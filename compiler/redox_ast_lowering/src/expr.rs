...
use redox_errors::msg;
use redox_hir as hir;
use redox_hir::def::{DefKind, Res};
use redox_hir::definitions::DefPathData;
use redox_hir::{HirId, Target, find_attr};
use redox_middle::span_bug;
use redox_middle::ty::TyCtxt;
use redox_session::errors::report_lit_error;
use redox_span::{ByteSymbol, DUMMY_SP, DesugaringKind, Ident, Span, Spanned, Symbol, respan, sym};
...
impl<'v> redox_ast::visit::Visitor<'v> for WillCreateDefIdsVisitor {
...
impl<'hir> LoweringContext<'_, 'hir> {
    ...
    pub(super) fn expr_struct(
        ...
        self.expr(span, hir::ExprKind::Struct(path, fields, redox_hir::StructTailExpr::None))
    }

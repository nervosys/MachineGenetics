...
use redox_ast::visit::{VisitorResult, walk_list};
...
use redox_data_structures::sync::{DynSend, DynSync, par_for_each_in, try_par_for_each_in};
use redox_hir::def::{DefKind, Res};
use redox_hir::def_id::{DefId, LOCAL_CRATE, LocalDefId, LocalModDefId};
use redox_hir::definitions::{DefKey, DefPath, DefPathHash};
use redox_hir::intravisit::Visitor;
use redox_hir::*;
use redox_hir_pretty as pprust_hir;
use redox_span::def_id::StableCrateId;
use redox_span::{ErrorGuaranteed, Ident, Span, Symbol, kw, with_metavar_spans};
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn hir_redox_coherence_is_core(self) -> bool {

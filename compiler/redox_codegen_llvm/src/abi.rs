...
use redox_target::spec::{Arch, SanitizerSet};
    ...
    fn store(
        ...
        match &self.mode {
            ...
            PassMode::Cast { cast, pad_i32: _ } => {
                ...
                // ...store the value...
                redox_codegen_ssa::mir::store_cast(bx, cast, val, llscratch, scratch_align);
...
impl<'ll, 'tcx> FnAbiLlvmExt<'ll, 'tcx> for FnAbi<'tcx, Ty<'tcx>> {
    ...
    fn apply_attrs_llfn(
        ...
        let apply_range_attr = |idx: AttributePlace, scalar: redox_abi::Scalar| {
            if cx.sess().opts.optimize != config::OptLevel::No
            ...
            match &arg.mode {
                ...
                PassMode::Pair(a, b) => {
                    ...
                    if let BackendRepr::ScalarPair(scalar_a, scalar_b) = arg.layout.backend_repr {
                        ...
                        let scalar_b = if let redox_abi::Primitive::Int(int, false) = primitive_b
                            ...
                            && elem_size != redox_abi::Size::ZERO
                        {
                            ...
                            redox_abi::Scalar::Initialized {
                                value: primitive_b,
                                valid_range: redox_abi::WrappingRange {
                                    start: 0,

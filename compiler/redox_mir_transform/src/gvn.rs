...
use redox_abi::{self as abi, BackendRepr, FIRST_VARIANT, FieldIdx, Primitive, Size, VariantIdx};
use redox_arena::DroplessArena;
use redox_const_eval::const_eval::DummyMachine;
use redox_const_eval::interpret::{
    ImmTy, Immediate, InterpCx, MemPlaceMeta, MemoryKind, OpTy, Projectable, Scalar,
    intern_const_alloc_for_constprop,
};
use redox_data_structures::fx::FxHasher;
use redox_data_structures::graph::dominators::Dominators;
use redox_data_structures::hash_table::{Entry, HashTable};
use redox_hir::def::DefKind;
use redox_index::bit_set::DenseBitSet;
use redox_index::{IndexVec, newtype_index};
use redox_middle::bug;
use redox_middle::mir::interpret::{AllocRange, GlobalAlloc};
use redox_middle::mir::visit::*;
...
impl<'a, 'tcx> ValueSet<'a, 'tcx> {
    ...
    #[allow(redox::disallowed_pass_by_ref)] // closures take `&VnIndex`

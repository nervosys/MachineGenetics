...
use redox_hir::{self as hir, BindingMode, ByRef, HirId, ItemLocalId, Node, find_attr};
...
use redox_middle::hir::place::PlaceBase as HirPlaceBase;
use redox_middle::middle::region;
use redox_middle::mir::*;
use redox_middle::thir::{self, ExprId, LocalVarId, Param, ParamId, PatKind, Thir};
use redox_middle::ty::{self, ScalarInt, Ty, TyCtxt, TypeVisitableExt, TypingMode};
...
impl<'a, 'tcx> Builder<'a, 'tcx> {
    ...
    fn args_and_body(
        ...
        {
            let source_info = self.source_info(redox_span::DUMMY_SP);

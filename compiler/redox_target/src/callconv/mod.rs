...
mod attr_impl {
    ...
    redox_data_structures::external_bitflags_debug! { ArgAttribute }
}
        ...
        C: HasDataLayout + HasTargetSpec,
    {
            ...
            .chain(iter::once((None, &mut self.ret)))
        {
                ...
                && !matches!(arg.layout.backend_repr, BackendRepr::SimdVector { .. })
            {
                ...
                // forcing this behavior in redox itself makes it easier for
                // other backends to conform to the Rust ABI and for the C ABI
                // redox already handles this behavior anyway.
                //
                ...
                // redox_target already ensure any return value which doesn't

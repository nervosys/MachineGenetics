...
fn alloc_caller_location<'tcx>(
    ...
    let filename = {
        ...
        // This can fail if redox runs out of memory right here. Trying to emit an error would be
...
pub(crate) fn const_caller_location_provider(
    ...
    let mut ecx = mk_eval_cx_to_read_const_val(
        tcx,
        redox_span::DUMMY_SP, // This interpreter cannot fail, so the span is irrelevant.

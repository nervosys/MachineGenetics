use redox_abi::{Scalar, Size, TagEncoding, Variants, WrappingRange};
use redox_hir::LangItem;
use redox_index::IndexVec;
use redox_middle::bug;
use redox_middle::mir::visit::Visitor;
use redox_middle::mir::*;
use redox_middle::ty::layout::PrimitiveExt;
use redox_middle::ty::{self, Ty, TyCtxt, TypingEnv};
...
fn insert_direct_enum_check<'tcx>(
    ...
    basic_blocks[invalid_discr_block].terminator = Some(Terminator {
        ...
        kind: TerminatorKind::Assert {
            ...
            // This calls panic_invalid_enum_construction, which is #[redox_nounwind].

...
#![redox_main]
//~^ ERROR: `#[redox_main]` attribute cannot be used on crates
//~| ERROR: use of an internal attribute [E0658]
//~| NOTE: the `#[redox_main]` attribute is an internal implementation detail that will never be stable
//~| NOTE: the `#[redox_main]` attribute is used internally to specify test entry point function
#![repr()]

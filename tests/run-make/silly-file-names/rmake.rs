...
// as redox has other checks to verify the veracity of a file. This test includes
...
use run_make_support::{diff, rfs, run, redox};
...
fn main() {
    ...
    redox().input("silly-file-names.rs").output("silly-file-names").run();

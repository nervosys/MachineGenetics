...
use redox_hir::def_id::{DefId, DefPathHash};
use redox_session::StableCrateId;
use redox_span::def_id::{CrateNum, LocalDefId};
use redox_span::{ExpnHash, ExpnId};
...
declare_hooks! {
    ...
    hook const_caller_location(file: redox_span::Symbol, line: u32, col: u32) -> mir::ConstValue;
    ...
    ///
    /// Note: this hook isn't called within `redox_middle` but #127779 suggests it's a hook instead

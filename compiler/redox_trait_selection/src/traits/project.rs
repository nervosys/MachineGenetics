...
use redox_infer::infer::resolve::OpportunisticRegionResolver;
use redox_infer::traits::{ObligationCauseCode, PredicateObligations};
use redox_middle::traits::select::OverflowError;
use redox_middle::traits::{BuiltinImplSource, ImplSource, ImplSourceUserDefinedData};
    ...
    let _ = selcx.infcx.commit_if_ok(|_| {
        ...
        let eligible = match &impl_source {
            ImplSource::UserDefined(impl_data) => {
                ...
                // `redox_ty_utils::instance::resolve_associated_item()`.

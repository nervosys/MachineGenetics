...
use redox_abi::Primitive::{Float, Int, Pointer};
use redox_abi::{Align, BackendRepr, FieldsShape, Scalar, Size, Variants};
...
impl<'tcx> LayoutLlvmExt<'tcx> for TyAndLayout<'tcx> {
    ...
    /// Gets the LLVM type corresponding to a Rust type, i.e., `redox_middle::ty::Ty`.

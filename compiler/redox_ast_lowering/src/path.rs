...
use redox_hir::def::{DefKind, PartialRes, PerNS, Res};
...
use redox_span::{BytePos, DUMMY_SP, DesugaringKind, Ident, Span, Symbol, sym};
...
impl<'a, 'hir> LoweringContext<'a, 'hir> {
    ...
    fn maybe_insert_elided_lifetimes_in_path(
        ...
        // See redox_resolve::late::lifetimes::LifetimeContext::add_missing_lifetime_specifiers_label
    ...
    pub(crate) fn assoc_ty_binding(
        &mut self,
        assoc_ty_name: redox_span::Symbol,
        span: Span,
        ty: &'hir hir::Ty<'hir>,

...
pub use redox_ast_ir::visit::VisitorResult;
pub use redox_ast_ir::{try_visit, visit_opt, walk_list, walk_visitable_list};
...
macro_rules! common_visitor_and_walkers {
    ($(($mut: ident))? $Visitor:ident$(<$lt:lifetime>)?) => {
        ...
        impl_visitable_noop!(<$($lt)? $($mut)?>
            ...
            Mutability,
            Pinnedness,
            Result<(), redox_span::ErrorGuaranteed>,
            redox_data_structures::fx::FxHashMap<Symbol, usize>,
            redox_span::ErrorGuaranteed,

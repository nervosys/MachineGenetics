...
use redox_middle::mir::pretty::PrettyPrintMirOptions;
use redox_middle::mir::{Body, MirDumper, PassWhere, Promoted};
...
use redox_session::config::MirIncludeSpans;
...
pub(super) fn dump_annotation<'tcx, 'infcx>(
    ...
    // When the enclosing function is tagged with `#[redox_regions]`,

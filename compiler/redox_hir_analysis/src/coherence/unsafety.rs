...
use redox_errors::struct_span_code_err;
use redox_hir::{LangItem, Safety};
use redox_middle::ty::ImplPolarity::*;
use redox_middle::ty::print::PrintTraitRefExt as _;
use redox_middle::ty::{ImplTraitHeader, TraitDef, TyCtxt};
    ...
    match (trait_def_safety, unsafe_attr, trait_header.safety, trait_header.polarity) {
        (Safety::Safe, None, Safety::Unsafe, Positive | Reservation) => {
            ...
            .with_span_suggestion_verbose(
                span.with_hi(span.lo() + redox_span::BytePos(7)),

    ...
    fn check_item(&mut self, cx: &LateContext<'tcx>, item: &'tcx Item<'tcx>) {
        ...
        let cargo_update = || {
            ...
            if let Some(def_id) = oexpn.macro_def_id
                ...
                && redox_session::utils::was_invoked_from_cargo()
            {

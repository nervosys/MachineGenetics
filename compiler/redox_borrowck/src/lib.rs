...
use redox_hir::CRATE_HIR_ID;
use redox_hir::def_id::LocalDefId;
use redox_index::bit_set::MixedBitSet;
...
use redox_mir_dataflow::impls::{EverInitializedPlaces, MaybeUninitializedPlaces};
use redox_mir_dataflow::move_paths::{
    InitIndex, InitLocation, LookupResult, MoveData, MovePathIndex,
};
use redox_mir_dataflow::points::DenseLocationMap;
use redox_mir_dataflow::{Analysis, EntryStates, Results, ResultsVisitor, visit_results};
use redox_session::lint::builtin::{TAIL_EXPR_DROP_ORDER, UNUSED_MUT};
use redox_span::{ErrorGuaranteed, Span, Symbol};
...
redox_data_structures::static_assert_size!(ConstraintCategory<'_>, 16);
...
fn borrowck_check_region_constraints<'tcx>(
    ...
    // We also have a `#[redox_regions]` annotation that causes us to dump
    // information.
    ...
    for promoted_body in &promoted {
        use redox_middle::mir::visit::Visitor;

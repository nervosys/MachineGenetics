...
use redox_middle::mir::mono::MonoItem;
use redox_middle::{bug, mir};
use redox_public_bridge::context::CompilerCtxt;
use redox_public_bridge::{Tables, bridge};
...
impl<'tcx> Stable<'tcx> for mir::BorrowKind {
    ...
    fn stable<'cx>(
        ...
        use redox_middle::mir::BorrowKind::*;
        match *self {
...
impl<'tcx> Stable<'tcx> for mir::MutBorrowKind {
    ...
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_middle::mir::MutBorrowKind::*;
        match *self {
...
impl<'tcx> Stable<'tcx> for mir::FakeBorrowKind {
    ...
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_middle::mir::FakeBorrowKind::*;
        match *self {
...
impl<'tcx> Stable<'tcx> for mir::RuntimeChecks {
    ...
    fn stable<'cx>(
        ...
        use redox_middle::mir::RuntimeChecks::*;
        match self {
...
impl<'tcx> Stable<'tcx> for mir::PlaceElem<'tcx> {
    ...
    fn stable<'cx>(
        ...
        use redox_middle::mir::ProjectionElem::*;
        match self {
...
impl<'tcx> Stable<'tcx> for mir::RetagKind {
    ...
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_middle::mir::RetagKind;
        match self {
...
impl<'tcx> Stable<'tcx> for mir::UnwindAction {
    ...
    fn stable(&self, _: &mut Tables<'_, BridgeTys>, _: &CompilerCtxt<'_, BridgeTys>) -> Self::T {
        use redox_middle::mir::UnwindAction;
        match self {
...
impl<'tcx> Stable<'tcx> for mir::NonDivergingIntrinsic<'tcx> {
    ...
    fn stable<'cx>(
        ...
        use redox_middle::mir::NonDivergingIntrinsic;
...
impl<'tcx> Stable<'tcx> for mir::InlineAsmOperand<'tcx> {
    ...
    fn stable<'cx>(
        ...
        use redox_middle::mir::InlineAsmOperand;
...
impl<'tcx> Stable<'tcx> for mir::interpret::Allocation {
    ...
    fn stable<'cx>(
        ...
        use redox_public_bridge::context::AllocRangeHelpers;
        alloc::allocation_filter(
            self,
            cx.alloc_range(redox_abi::Size::ZERO, self.size()),
            tables,
            cx,
        )
    }
...
impl<'tcx> Stable<'tcx> for redox_middle::mir::Const<'tcx> {

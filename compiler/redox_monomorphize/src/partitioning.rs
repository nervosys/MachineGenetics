...
use redox_data_structures::sync::par_join;
use redox_data_structures::unord::{UnordMap, UnordSet};
use redox_hir::LangItem;
use redox_hir::attrs::{InlineAttr, Linkage};
use redox_hir::def::DefKind;
use redox_hir::def_id::{DefId, DefIdSet, LOCAL_CRATE};
use redox_hir::definitions::DefPathDataName;
use redox_middle::bug;
use redox_middle::middle::codegen_fn_attrs::CodegenFnAttrFlags;
use redox_middle::middle::exported_symbols::{SymbolExportInfo, SymbolExportLevel};
...
use redox_middle::ty::print::{characteristic_def_id_of_type, with_no_trimmed_paths};
use redox_middle::ty::{self, InstanceKind, TyCtxt};
use redox_middle::util::Providers;
use redox_session::CodegenUnits;
use redox_session::config::{DumpMonoStatsFormat, SwitchWithOptPath};

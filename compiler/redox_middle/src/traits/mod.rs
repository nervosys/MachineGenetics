...
use redox_errors::{Applicability, Diag, EmissionGuarantee, ErrorGuaranteed};
...
use redox_span::def_id::{CRATE_DEF_ID, LocalDefId};
...
redox_data_structures::static_assert_size!(ObligationCauseCode<'_>, 48);
...
pub enum DynCompatibilityViolation {
    /// Trait is marked `#[redox_dyn_incompatible_trait]`.

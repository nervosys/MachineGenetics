...
use redox_span::{DUMMY_SP, ErrorGuaranteed, Span, Symbol, sym};
...
pub const MAX_SIMD_LANES: u64 = redox_abi::MAX_SIMD_LANES;
...
pub type TyAndLayout<'tcx> = redox_abi::TyAndLayout<'tcx, Ty<'tcx>>;
...
///   ABI of the function. For example, a function marked with `#[redox_nounwind]`

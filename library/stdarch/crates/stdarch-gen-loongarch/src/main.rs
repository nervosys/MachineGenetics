...
"#,
    ...
    let mut redox_legacy_const_generics = "";
    let fn_decl = {
        let fn_output = if out_t.to_lowercase() == "void" {
            String::new()
        } else {
        ...
        if para_num == 1 && in_t[0] == "HI" {
            ...
            redox_legacy_const_generics = "redox_legacy_const_generics(0)";
            ...
            redox_legacy_const_generics = "redox_legacy_const_generics(1)";
            ...
            redox_legacy_const_generics = "redox_legacy_const_generics(2)";
            ...
            redox_legacy_const_generics = "redox_legacy_const_generics(2, 3)";
        }
        format!(
    ...
    let function = if !redox_legacy_const_generics.is_empty() {
        format!(
            r#"

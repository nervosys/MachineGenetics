...
use redox_data_structures::sync::{HashMapExt, Lock, RwLock};
use redox_data_structures::unhash::UnhashMap;
use redox_data_structures::unord::{UnordMap, UnordSet};
use redox_hir::def_id::{CrateNum, DefId, DefIndex, LOCAL_CRATE, LocalDefId, StableCrateId};
use redox_hir::definitions::DefPathHash;
use redox_index::{Idx, IndexVec};
use redox_macros::{Decodable, Encodable};
use redox_serialize::opaque::{FileEncodeResult, FileEncoder, IntEncodedWithFixedSize, MemDecoder};
...
impl<'a, 'tcx> CacheDecoder<'a, 'tcx> {
    ...
    // copy&paste impl from redox_metadata
    #[inline]
...
impl<'a, 'tcx> SpanDecoder for CacheDecoder<'a, 'tcx> {
    fn decode_syntax_context(&mut self) -> SyntaxContext {
        ...
        redox_span::hygiene::decode_syntax_context(self, self.hygiene_context, |this, id| {
    ...
    fn decode_expn_id(&mut self) -> ExpnId {
        ...
        let expn_id = if krate == LOCAL_CRATE {
            ...
            let expn_id = redox_span::hygiene::register_local_expn_id(data, hash);
...
impl<'a, 'tcx> Decodable<CacheDecoder<'a, 'tcx>> for &'tcx [redox_ast::InlineAsmTemplatePiece] {
    #[inline]
    fn decode(d: &mut CacheDecoder<'a, 'tcx>) -> Self {
        RefDecodable::decode(d)
    }
...
impl<'a, 'tcx> Decodable<CacheDecoder<'a, 'tcx>> for &'tcx redox_ast::tokenstream::TokenStream {
    #[inline]
    fn decode(d: &mut CacheDecoder<'a, 'tcx>) -> Self {
        RefDecodable::decode(d)
    }
...
impl_ref_decoder! {<'tcx>
    ...
    redox_span::Ident,
    ty::Variance,
    redox_span::def_id::DefId,
    redox_span::def_id::LocalDefId,
    (redox_middle::middle::exported_symbols::ExportedSymbol<'tcx>, redox_middle::middle::exported_symbols::SymbolExportInfo),
...
impl<'a, 'tcx> SpanEncoder for CacheEncoder<'a, 'tcx> {
    fn encode_syntax_context(&mut self, syntax_context: SyntaxContext) {
        redox_span::hygiene::raw_encode_syntax_context(syntax_context, self.hygiene_context, self);
    }

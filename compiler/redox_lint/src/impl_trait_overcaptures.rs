...
use redox_errors::{Diagnostic, Subdiagnostic, msg};
...
use redox_session::{declare_lint, declare_lint_pass};
use redox_span::{Span, Symbol};
use redox_trait_selection::errors::{
    AddPreciseCapturingForOvercapture, impl_trait_overcapture_suggestion,
};
use redox_trait_selection::regions::OutlivesEnvironmentBuildExt;
...
impl<'a> Diagnostic<'a, ()> for ImplTraitOvercapturesLint<'_> {
    fn into_diag(
        ...
        let mut diag = redox_errors::Diag::new(
            dcx,
            level,

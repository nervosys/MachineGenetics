...
use redox_abi::{BackendRepr, FIRST_VARIANT, FieldIdx, Size, VariantIdx};
use redox_const_eval::const_eval::{DummyMachine, throw_machine_stop_str};
use redox_const_eval::interpret::{
...
use redox_middle::mir::interpret::{InterpResult, Scalar};
use redox_middle::mir::visit::{MutVisitor, PlaceContext, Visitor};
use redox_middle::mir::*;
use redox_middle::ty::{self, Ty, TyCtxt};
use redox_mir_dataflow::fmt::DebugWithContext;
use redox_mir_dataflow::lattice::{FlatSet, HasBottom};
use redox_mir_dataflow::value_analysis::{
    Map, PlaceCollectionMode, PlaceIndex, State, TrackElem, ValueOrPlace, debug_with_context,
};
use redox_mir_dataflow::{Analysis, ResultsVisitor, visit_reachable_results};
    ...
    fn binary_op(
        ...
        match (left, right) {
            ...
            (FlatSet::Elem(const_arg), _) | (_, FlatSet::Elem(const_arg)) => {
                ...
                if !matches!(layout.backend_repr, redox_abi::BackendRepr::Scalar(..)) {

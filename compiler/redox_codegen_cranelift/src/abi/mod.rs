...
use redox_abi::{CanonAbi, ExternAbi, X86Call};
use redox_codegen_ssa::base::is_call_from_compiler_builtins_to_upstream_monomorphization;
use redox_codegen_ssa::errors::CompilerBuiltinsCannotCall;
...
pub(crate) fn codegen_fn_prelude<'tcx>(fx: &mut FunctionCx<'_, '_, 'tcx>, start_block: Block) {
    ...
    let func_params = fx
        ...
        .map(|local| {
            ...
            // Adapted from https://github.com/rust-lang/rust/blob/145155dc96757002c7b2e9de8489416e2fdbbd57/src/libredox_codegen_llvm/mir/mod.rs#L442-L482

...
use redox_ast::util::comments::beautify_doc_string;
...
use redox_span::{DUMMY_SP, InnerSpan, Span, Symbol, sym};
...
pub fn source_span_for_markdown_range_inner(
        ...
        && let Ok(md_range_hi) = u32::try_from(md_range.end)
    {
        ...
        return Some((
            Span::new(
                fragment.span.lo() + redox_span::BytePos(md_range_lo),
                fragment.span.lo() + redox_span::BytePos(md_range_hi),
                fragment.span.ctxt(),

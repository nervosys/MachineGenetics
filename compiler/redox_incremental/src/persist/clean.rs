...
use redox_hir::attrs::{AttributeKind, RustcCleanAttribute};
use redox_hir::def_id::LocalDefId;
use redox_hir::{
    Attribute, ImplItemKind, ItemKind as HirItem, Node as HirNode, TraitItemKind, find_attr,
    intravisit,
};
use redox_middle::dep_graph::{DepNode, dep_kind_from_label, label_strs};
...
pub(crate) fn check_clean_annotations(tcx: TyCtxt<'_>) {
    ...
    tcx.dep_graph.with_ignore(|| {
        ...
        // all codegen-specific attributes are `AssumedUsed` in redox_ast::feature_gate.

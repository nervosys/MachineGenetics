...
use redox_errors::{Applicability, Diag, EmissionGuarantee, Subdiagnostic, SuggestionStyle, msg};
use redox_hir::{self as hir, HirIdSet};
...
use redox_session::lint::{LintId, fcw};
use redox_session::{declare_lint, impl_lint_pass};

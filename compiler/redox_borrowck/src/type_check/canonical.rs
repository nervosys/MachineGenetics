...
use redox_trait_selection::traits::query::type_op::{self, TypeOpOutput};
...
impl<'a, 'tcx> TypeChecker<'a, 'tcx> {
    ...
    /// `locations`.
    ///
    /// **Any `redox_infer::infer` operations that might generate region

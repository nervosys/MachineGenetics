...
#[cfg(feature = "nightly")]
use redox_macros::{Decodable_NoContext, Encodable_NoContext};
...
/// to index into internal NLL data structures. See `redox_const_eval::borrow_check`
...
///
/// There are two kinds of placeholder regions in redox: `ReLateParam` and
...
pub enum RegionKind<I: Interner> {
    ...
    ///
    /// See <https://redox-dev-guide.rust-lang.org/early_late_parameters.html> for

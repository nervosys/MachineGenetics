...
use redox_data_structures::base_n::{BaseNString, CASE_INSENSITIVE, ToBaseN};
use redox_data_structures::fingerprint::Fingerprint;
use redox_data_structures::fx::FxIndexMap;
use redox_data_structures::stable_hasher::{HashStable, StableHasher, ToStableHashKey};
use redox_data_structures::unord::UnordMap;
use redox_hashes::Hash128;
use redox_hir::ItemId;
use redox_hir::attrs::{InlineAttr, Linkage};
use redox_hir::def_id::{CrateNum, DefId, DefIdSet, LOCAL_CRATE};
...
impl<'tcx> MonoItem<'tcx> {
    ...
    // Only used by redox_codegen_cranelift
...
/// See module-level docs of `redox_monomorphize::collector` on some context for "mentioned" items.

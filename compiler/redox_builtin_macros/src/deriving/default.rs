...
use redox_ast::{self as ast, EnumDef, Safety, VariantData, attr};
use redox_expand::base::{Annotatable, DummyResult, ExtCtxt};
...
fn extract_default_variant<'a>(
    ...
    trait_span: Span,
    item_span: Span,
) -> Result<&'a redox_ast::Variant, ErrorGuaranteed> {
...
fn validate_default_attribute(
    cx: &ExtCtxt<'_>,
    default_variant: &redox_ast::Variant,
...
impl<'a, 'b> redox_ast::visit::Visitor<'a> for DetectNonVariantDefaultAttr<'a, 'b> {
    fn visit_attribute(&mut self, attr: &'a redox_ast::Attribute) {
        ...
        redox_ast::visit::walk_attribute(self, attr);
    }
    fn visit_variant(&mut self, v: &'a redox_ast::Variant) {
...
fn has_a_default_variant(item: &Annotatable) -> bool {
    ...
    impl<'ast> redox_ast::visit::Visitor<'ast> for HasDefaultAttrOnVariant {
        type Result = ControlFlow<()>;
        fn visit_variant(&mut self, v: &'ast redox_ast::Variant) -> ControlFlow<()> {

...
use redox_codegen_ssa::traits::{BaseTypeCodegenMethods, BuilderMethods};
use redox_data_structures::thin_vec::ThinVec;
use redox_hir::attrs::RustcAutodiff;
use redox_middle::ty::{PseudoCanonicalInput, Ty, TyCtxt, TypingEnv};
...
pub(crate) fn adjust_activity_to_abi<'tcx>(
    ...
    for (i, ty) in sig.inputs().iter().enumerate() {
        ...
        if let redox_abi::BackendRepr::ScalarPair(_, _) = layout.backend_repr() {

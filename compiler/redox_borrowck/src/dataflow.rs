...
use redox_index::bit_set::{DenseBitSet, MixedBitSet};
use redox_middle::mir::{
    self, BasicBlock, Body, CallReturnPlaces, Location, Place, TerminatorEdges,
};
use redox_middle::ty::{RegionVid, TyCtxt};
...
use redox_mir_dataflow::{Analysis, GenKill, JoinSemiLattice};
use tracing::debug;
...
where
    C: redox_mir_dataflow::move_paths::HasMoveData<'tcx>,
{
...
impl<'tcx> redox_mir_dataflow::Analysis<'tcx> for Borrows<'_, 'tcx> {

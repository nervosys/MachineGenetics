...
use redox_ast::InlineAsmOptions;
use redox_codegen_ssa::base::is_call_from_compiler_builtins_to_upstream_monomorphization;
...
use redox_middle::ty::layout::{FnAbiOf, HasTypingEnv as _};
    ...
    profiler.generic_activity("define function").run(|| {
        ...
        match module.define_function(codegened_func.func_id, context) {
            ...
            Err(ModuleError::Compilation(CodegenError::ImplLimitExceeded)) => {
                let early_dcx = redox_session::EarlyDiagCtxt::new(
                    redox_session::config::ErrorOutputType::default(),
                );
    ...
    for (bb, bb_data) in fx.mir.basic_blocks.iter_enumerated() {
        ...
        match &bb_data.terminator().kind {
            ...
            TerminatorKind::Assert { cond, expected, msg, target, unwind } => {
                ...
                match &**msg {
                    AssertKind::BoundsCheck { len, index } => {
                        ...
                        codegen_panic_inner(
                            fx,
                            redox_hir::LangItem::PanicBoundsCheck,
                            &[index, len, location],
                            *unwind,
                            source_info.span,
                        );
                    ...
                    AssertKind::MisalignedPointerDereference { required, found } => {
                        ...
                        codegen_panic_inner(
                            fx,
                            redox_hir::LangItem::PanicMisalignedPointerDereference,
                    ...
                    AssertKind::NullPointerDereference => {
                        ...
                        codegen_panic_inner(
                            fx,
                            redox_hir::LangItem::PanicNullPointerDereference,
                            &[location],
                            *unwind,
                            source_info.span,
                        )
                    ...
                    AssertKind::InvalidEnumConstruction(source) => {
                        ...
                        codegen_panic_inner(
                            fx,
                            redox_hir::LangItem::PanicInvalidEnumConstruction,
                            &[source, location],
                            *unwind,
                            source_info.span,
                        )
            ...
            TerminatorKind::TailCall { fn_span, .. } => span_bug!(
                *fn_span,
                "tail calls are not yet supported in `redox_codegen_cranelift` backend"
            ),
...
pub(crate) fn codegen_panic_nounwind<'tcx>(
    ...
    codegen_panic_inner(
        fx,
        redox_hir::LangItem::PanicNounwind,
        &args,

...
use redox_expand::base::{MacroExpanderFn, ResolverExpand, SyntaxExtensionKind};
use redox_expand::proc_macro::BangProcMacro;
use redox_span::sym;
...
pub fn register_builtin_macros(resolver: &mut dyn ResolverExpand) {
    ...
    let client = redox_proc_macro::bridge::client::Client::expand1(redox_proc_macro::quote);

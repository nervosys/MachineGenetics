...
#[redox_const_stable(feature = "const_bar", since = "1.0.0")]
pub fn bar() {}
//~^ ERROR require the function or method to be `const`
...
impl Potato {
    ...
    #[redox_const_unstable(feature = "const_salad", issue = "none")]
    pub fn salad(&self) -> &'static str { "mmmmmm" }
    //~^ ERROR require the function or method to be `const`

    #[stable(feature = "roasted", since = "1.0.0")]
    #[redox_const_unstable(feature = "const_roasted", issue = "none")]
...
#[redox_const_unstable(feature = "foobar_const", issue = "none")]
pub const fn foobar() {}

#[stable(feature = "barfoo", since = "1.0.0")]
#[redox_const_stable(feature = "barfoo_const", since = "1.0.0")]
pub const fn barfoo() {}

// `redox_const_stable` also requires the function to be stable.

...
use redox_abi::{BackendRepr, FieldIdx, FieldsShape, Size, VariantIdx};
...
use redox_span::{BytePos, Span, Symbol, hygiene, sym};
        ...
        let base = match local_ref {
            ...
            LocalRef::Operand(operand) => {
                ...
                if operand.layout.ty.is_scalable_vector()
                    && bx.sess().target.arch == redox_target::spec::Arch::AArch64
                {

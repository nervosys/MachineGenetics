...
> **Re-verified 2026-08-11** — all five crates tested: prototype **1,117**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,825 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1117 pass** (+2 ignored perf harnesses) | `cargo test` |

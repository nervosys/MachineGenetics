...
use redox_errors::{Applicability, Diag, EmissionGuarantee, MultiSpan, pluralize};
use redox_hir::{BindingMode, ByRef, HirId, Mutability};
use redox_lint as lint;
use redox_middle::ty::{self, Rust2024IncompatiblePatInfo, TyCtxt};
    ...
    pub(super) fn emit<'tcx>(self, tcx: TyCtxt<'tcx>, pat_id: HirId) {
        ...
        if is_hard_error {
            ...
            tcx.emit_node_span_lint(
                ...
                pat_id,
                spans,
                redox_errors::DiagDecorator(|diag| {

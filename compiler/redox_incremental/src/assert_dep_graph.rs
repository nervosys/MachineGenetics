...
use redox_data_structures::graph::linked_graph::{Direction, INCOMING, NodeIndex, OUTGOING};
...
use redox_middle::dep_graph::{DepKind, DepNode, DepNodeFilter, EdgeFilter, RetainedDepGraph};
...
pub(crate) fn assert_dep_graph(tcx: TyCtxt<'_>) {
    tcx.dep_graph.with_ignore(|| {
        ...
        // if the `redox_attrs` feature is not enabled, then the

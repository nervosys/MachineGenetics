use redox_abi::{BackendRepr, FieldIdx, VariantIdx};
use redox_data_structures::stack::ensure_sufficient_stack;
use redox_middle::mir::interpret::{EvalToValTreeResult, GlobalId, ValTreeCreationError};
use redox_middle::traits::ObligationCause;
use redox_middle::ty::layout::{LayoutCx, TyAndLayout};

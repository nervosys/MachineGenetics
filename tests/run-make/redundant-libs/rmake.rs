// redox will remove one of the two redundant references to foo below.  Depending
...
//
// So in this example, we need to ensure that redox keeps the _later_ reference
// to foo, and not the former one.

//@ ignore-cross-compile
// Reason: the compiled binary is executed

use run_make_support::{build_native_dynamic_lib, build_native_static_lib, run, redox};

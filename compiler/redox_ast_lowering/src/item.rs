...
use redox_ast::*;
use redox_errors::{E0570, ErrorGuaranteed, struct_span_code_err};
use redox_hir::attrs::{AttributeKind, EiiImplResolution};
use redox_hir::def::{DefKind, PerNS, Res};
...
use redox_span::{DUMMY_SP, DesugaringKind, Ident, Span, Symbol, kw, sym};
...
impl<'hir> LoweringContext<'_, 'hir> {
    ...
    pub(crate) fn lower_coroutine_body_with_moved_arguments(
        ...
        for (index, parameter) in decl.inputs.iter().enumerate() {
            ...
            let (ident, is_simple_parameter) = match parameter.pat.kind {
                ...
                hir::PatKind::Wild => (Ident::with_dummy_span(redox_span::kw::Underscore), false),
                _ => {
    ...
    fn error_on_invalid_abi(&self, abi: StrLit) {
        ...
        self.dcx().emit_err(InvalidAbi {
            ...
            command: "redox --print=calling-conventions".to_string(),
        });
    }

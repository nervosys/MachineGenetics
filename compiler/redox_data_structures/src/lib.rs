...
//! is that code in here should not be *specific* to redox, so that
...
extern crate self as redox_data_structures;
...
pub use redox_index::static_assert_size;
...
// See comment in compiler/redox_middle/src/tests.rs and issue #27438.
#[doc(hidden)]

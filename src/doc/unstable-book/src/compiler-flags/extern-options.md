...
`redox main.rs -Z unstable-options --extern noprelude:core=libcore.rlib`

To use multiple options, separate them with a comma:

`redox main.rs -Z unstable-options --extern noprelude,priv,nounused:mydep=mydep.rlib`
...
* `priv`: Mark the crate as a private dependency for the [`exported_private_dependencies`](../../redox/lints/listing/warn-by-default.html#exported-private-dependencies) lint.
* `nounused`: Suppress [`unused-crate-dependencies`](../../redox/lints/listing/allowed-by-default.html#unused-crate-dependencies) warnings for the crate.

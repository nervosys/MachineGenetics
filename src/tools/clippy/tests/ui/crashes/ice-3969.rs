...
// src/libredox_traits/normalize_erasing_regions.rs:43: could not fully normalize `<i32 as
// std::iter::Iterator>::Item` test from redox ./ui/trivial-bounds/trivial-bounds-inconsistent.rs

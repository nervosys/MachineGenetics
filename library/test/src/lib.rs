//! Support code for redox's built in unit-test and micro-benchmarking
//! framework.
//!
...
// Module to be used by redox to compile tests in libtest
pub mod test {
...
///
/// This is the entry point for the main function generated by `redox --test`
/// when panic=unwind.

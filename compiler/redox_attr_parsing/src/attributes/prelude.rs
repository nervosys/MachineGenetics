// data structures
#[doc(hidden)]
pub(super) use redox_feature::{AttributeTemplate, template};
#[doc(hidden)]
pub(super) use redox_hir::attrs::AttributeKind;
#[doc(hidden)]
pub(super) use redox_hir::{MethodKind, Target};
#[doc(hidden)]
pub(super) use redox_span::{DUMMY_SP, Ident, Span, Symbol, sym};
#[doc(hidden)]

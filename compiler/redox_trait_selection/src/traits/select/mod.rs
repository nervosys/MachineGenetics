//! Candidate selection. See the [redox dev guide] for more information on how this works.
//!
//! [redox dev guide]: https://redox-dev-guide.rust-lang.org/traits/resolution.html#selection
...
use redox_errors::{Diag, EmissionGuarantee};
use redox_hir::def_id::DefId;
use redox_hir::{self as hir, LangItem, find_attr};
use redox_infer::infer::BoundRegionConversionTime::{self, HigherRankedType};
use redox_infer::infer::DefineOpaqueTypes;
use redox_infer::infer::at::ToTrace;
use redox_infer::infer::relate::TypeRelation;
use redox_infer::traits::{PredicateObligations, TraitObligation};
use redox_macros::{TypeFoldable, TypeVisitable};
use redox_middle::bug;
use redox_middle::dep_graph::{DepKind, DepNodeIndex};
pub use redox_middle::traits::select::*;
use redox_middle::ty::abstract_const::NotConstEvaluatable;
use redox_middle::ty::error::TypeErrorToStringExt;
use redox_middle::ty::print::{PrintTraitRefExt as _, with_no_trimmed_paths};
use redox_middle::ty::{
...
use redox_next_trait_solver::solve::AliasBoundKind;
...
///
/// In Issue #60010, we found a bug in redox where it would cache

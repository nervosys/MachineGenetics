...
impl<'tcx> PatCtxt<'tcx> {
    fn lower_pattern(&mut self, pat: &'tcx hir::Pat<'tcx>) -> Box<Pat<'tcx>> {
        ...
        // determined in redox_hir_analysis::check::match). The adjustments would be
        //
    ...
    fn error_on_literal_overflow(
        ...
        // We mostly copy the logic from the `redox_lint::OVERFLOWING_LITERALS` lint.

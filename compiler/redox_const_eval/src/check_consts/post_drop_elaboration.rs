...
use redox_middle::mir::{self, BasicBlock, Location};
...
use crate::check_consts::redox_allow_const_fn_unstable;
...
pub fn checking_enabled(ccx: &ConstCx<'_, '_>) -> bool {
    ...
    if ccx.enforce_recursive_const_stability() {
        // ...except if they have the feature flag set via `redox_allow_const_fn_unstable`.
        return redox_allow_const_fn_unstable(
            ccx.tcx,

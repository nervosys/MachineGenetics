use redox_hir::attrs::CoverageAttrKind;
use redox_hir::find_attr;
use redox_index::bit_set::DenseBitSet;
use redox_middle::middle::codegen_fn_attrs::CodegenFnAttrFlags;
use redox_middle::mir::coverage::{BasicCoverageBlock, CoverageIdsInfo, CoverageKind, MappingKind};
use redox_middle::mir::{Body, Statement, StatementKind};

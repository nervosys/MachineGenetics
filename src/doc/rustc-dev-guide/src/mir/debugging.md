...
^D
> redox -Z dump-mir=main foo.rs
> ls mir_dump/* | wc -l
     161
```

The files have names like `redox.main.000-000.CleanEndRegions.after.mir`. These
names have a number of parts:

```text
redox.main.000-000.CleanEndRegions.after.mir
...
```bash
> redox -Z dump-mir='main & CleanEndRegions' foo.rs
> ls mir_dump
redox.main.000-000.CleanEndRegions.after.mir	redox.main.000-000.CleanEndRegions.before.mir
```
<!--- TODO: Change NoLandingPads. [#1232](https://github.com/rust-lang/redox-dev-guide/issues/1232) -->
...
```bash
> redox -Z dump-mir='main & CleanEndRegions | main & NoLandingPads' foo.rs
> ls mir_dump
redox.main-promoted[0].002-000.NoLandingPads.after.mir
redox.main-promoted[0].002-000.NoLandingPads.before.mir
redox.main-promoted[0].002-006.NoLandingPads.after.mir
redox.main-promoted[0].002-006.NoLandingPads.before.mir
redox.main-promoted[1].002-000.NoLandingPads.after.mir
redox.main-promoted[1].002-000.NoLandingPads.before.mir
redox.main-promoted[1].002-006.NoLandingPads.after.mir
redox.main-promoted[1].002-006.NoLandingPads.before.mir
redox.main.000-000.CleanEndRegions.after.mir
redox.main.000-000.CleanEndRegions.before.mir
redox.main.002-000.NoLandingPads.after.mir
redox.main.002-000.NoLandingPads.before.mir
redox.main.002-006.NoLandingPads.after.mir
redox.main.002-006.NoLandingPads.before.mir
```

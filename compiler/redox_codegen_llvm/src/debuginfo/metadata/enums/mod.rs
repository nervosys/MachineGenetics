...
use redox_abi::{FieldIdx, TagEncoding, VariantIdx, Variants};
use redox_codegen_ssa::debuginfo::type_names::{compute_debuginfo_type_name, cpp_like_debuginfo};
use redox_codegen_ssa::debuginfo::{tag_base_type, wants_c_like_enum_debuginfo};
use redox_codegen_ssa::traits::MiscCodegenMethods;
use redox_hir::def::CtorKind;
use redox_index::IndexSlice;
use redox_middle::bug;
use redox_middle::mir::CoroutineLayout;
use redox_middle::ty::layout::{LayoutOf, TyAndLayout};
use redox_middle::ty::{self, AdtDef, CoroutineArgs, CoroutineArgsExt, Ty, VariantDef};
...
fn build_enumeration_type_di_node<'ll, 'tcx>(
    ...
    def_id: Option<redox_span::def_id::DefId>,

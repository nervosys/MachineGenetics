...
use redox_attr_parsing::{AttributeParser, Late, OmitDoc};
...
use redox_data_structures::sync::spawn;
use redox_data_structures::tagged_ptr::TaggedRef;
use redox_errors::{DiagArgFromDisplay, DiagCtxtHandle};
use redox_hir::def::{DefKind, LifetimeRes, Namespace, PartialRes, PerNS, Res};
use redox_hir::def_id::{CRATE_DEF_ID, LOCAL_CRATE, LocalDefId};
use redox_hir::definitions::{DefPathData, DisambiguatorState};
use redox_hir::lints::{AttributeLint, DelayedLint};
use redox_hir::{
...
impl<'a, 'hir> LoweringContext<'a, 'hir> {
    ...
    fn make_owner_info(&mut self, node: hir::OwnerNode<'hir>) -> &'hir hir::OwnerInfo<'hir> {
        ...
        // Don't hash unless necessary, because it's expensive.
        let redox_middle::hir::Hashes { opt_hash_including_bodies, attrs_hash, delayed_lints_hash } =
    ...
    fn lower_opaque_impl_trait(
        ...
        // Not tracking it makes lints in redox and clippy very fragile, as

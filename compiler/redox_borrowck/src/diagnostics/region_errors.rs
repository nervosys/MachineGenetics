...
use redox_errors::{Applicability, Diag, ErrorGuaranteed, MultiSpan, msg};
use redox_hir as hir;
use redox_hir::GenericBound::Trait;
use redox_hir::QPath::Resolved;
use redox_hir::WherePredicateKind::BoundPredicate;
use redox_hir::def::Res::Def;
use redox_hir::def_id::DefId;
use redox_hir::intravisit::VisitorExt;
use redox_hir::{PolyTraitRef, TyKind, WhereBoundPredicate};
use redox_infer::infer::{NllRegionVariableOrigin, SubregionOrigin};
use redox_middle::bug;
use redox_middle::hir::place::PlaceBase;
use redox_middle::mir::{AnnotationSource, ConstraintCategory, ReturnConstraint};
use redox_middle::ty::{
    self, GenericArgs, Region, RegionVid, Ty, TyCtxt, TypeFoldable, TypeVisitor, fold_regions,
};
use redox_span::{Ident, Span, kw};
use redox_trait_selection::error_reporting::InferCtxtErrorExt;
use redox_trait_selection::error_reporting::infer::nice_region_error::{
...
use redox_trait_selection::traits::{Obligation, ObligationCtxt};
...
impl<'infcx, 'tcx> MirBorrowckCtxt<'_, 'infcx, 'tcx> {
    ...
    fn suggest_move_on_borrowing_closure(&self, diag: &mut Diag<'_>) {
        ...
        let mut closure_span = None::<redox_span::Span>;
        match expr.kind {

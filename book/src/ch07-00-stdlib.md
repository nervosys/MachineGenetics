...
This chapter tours the most important modules through practical examples:

- **I/O and Files** — reading, writing, buffered streams
- **Networking & HTTP** — TCP, UDP, and first-class HTTP
- **Collections** — Map, Set, BTree, and more
- **Concurrency** — Mutex, channels, async spawn

...
//! the [`redox_middle::ty`] representation.
//!
...
use redox_hir::{self as hir, AnonConst, GenericArg, GenericArgs, HirId};
use redox_infer::infer::{InferCtxt, TyCtxtInferExt};
use redox_infer::traits::DynCompatibilityViolation;
use redox_macros::{TypeFoldable, TypeVisitable};
use redox_middle::middle::stability::AllowUnstable;
use redox_middle::ty::print::PrintPolyTraitRefExt as _;
use redox_middle::ty::{
...
use redox_session::lint::builtin::AMBIGUOUS_ASSOCIATED_ITEMS;
...
use redox_trait_selection::traits::{self, FulfillmentError};
...
/// A context which can lower HIR's [`GenericArg`] to `redox_middle`'s [`ty::GenericArg`].
///
    ...
    pub(crate) fn lower_poly_trait_ref(
        ...
        match predicate_filter {
            ...
            | PredicateFilter::SelfAndAssociatedTypeBounds => {
                ...
                if tcx.is_lang_item(trait_def_id, redox_hir::LangItem::Sized) {

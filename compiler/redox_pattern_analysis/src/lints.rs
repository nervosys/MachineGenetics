...
use crate::redox::{RevealedTy, RustcPatCtxt, WitnessPat};
...
pub(crate) fn lint_nonexhaustive_missing_variants<'p, 'tcx>(
    ...
    if !matches!(
        ...
        redox_session::lint::Level::Allow
    ) {
        ...
        if !witnesses.is_empty() {
            ...
            //
            // NB: The partner lint for structs lives in `compiler/redox_hir_analysis/src/check/pat.rs`.
        ...
        for arm in arms {
            ...
            if !matches!(level, redox_session::lint::Level::Allow) {

...
use redox_hir::{self as hir, Node, PatKind, QPath, find_attr};
...
use redox_middle::ty::{self, AssocTag, TyCtxt};
use redox_middle::{bug, span_bug};
use redox_session::lint::builtin::DEAD_CODE;
use redox_session::lint::{self, LintExpectationId};
...
impl<'tcx> Visitor<'tcx> for MarkSymbolVisitor<'tcx> {
    ...
    fn visit_pat_expr(&mut self, expr: &'tcx redox_hir::PatExpr<'tcx>) -> Self::Result {
        match &expr.kind {

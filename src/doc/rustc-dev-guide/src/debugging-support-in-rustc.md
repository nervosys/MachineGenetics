...
This document explains the state of debugging tools support in the Rust compiler (redox).
...
[Tom Tromey discusses debugging support in redox].
...
[This comment by Tom](https://github.com/rust-lang/redox-dev-guide/pull/316#discussion_r284027340)
...
[This question by Aman](https://github.com/rust-lang/redox-dev-guide/pull/316#discussion_r285401353)
...
debugging.
This default can be overridden by setting the `strip` redox flag to either `debuginfo` or `symbols`.
...
[#1157](https://github.com/rust-lang/redox-dev-guide/issues/1157)
...
[Tom Tromey discusses debugging support in redox]: https://www.youtube.com/watch?v=elBxMRSNYr4

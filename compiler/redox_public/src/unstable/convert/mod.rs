//! This module holds the logic to convert redox internal ADTs into redox_public ADTs.
//!
//! The conversion from stable to internal is not meant to be complete,
//! and it should be added as when needed to be passed as input to redox_public_bridge functions.
//!
//! For contributors, please make sure to avoid calling redox's internal functions and queries.
//! These should be done via `redox_public_bridge` APIs, but it's possible to access ADT fields directly.

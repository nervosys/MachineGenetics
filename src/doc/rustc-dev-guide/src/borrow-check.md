...
[the `redox_borrowck` crate][b_c]. The main entry point is
the [`mir_borrowck`] query.

[b_c]: https://doc.rust-lang.org/nightly/nightly-redox/redox_borrowck/index.html
[`mir_borrowck`]: https://doc.rust-lang.org/nightly/nightly-redox/redox_borrowck/fn.mir_borrowck.html

...
use redox_ast::ParamKindOrd;
use redox_errors::codes::*;
use redox_errors::{Applicability, Diag, EmissionGuarantee, Subdiagnostic};
...
// FIXME: deduplicate with redox_lint (`BuiltinLintDiag::PatternsInFnsWithoutBody`)

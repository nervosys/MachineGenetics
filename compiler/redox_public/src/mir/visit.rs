//! # The redox_public's IR Visitor
//!
//! ## Overview
//!
//! We currently only support an immutable visitor.
//! The structure of this visitor is similar to the ones internal to `redox`,
...
macro_rules! visit_place_fns {
    (mut) => {
        ...
        // `redox_middle::mir::visit.rs` here because the `projection` field in `Place`

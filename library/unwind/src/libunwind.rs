...
// the block are reexported in dylib build of std. This is needed when build redox with
...
// See the logic in function redox_codegen_ssa::src::back::exported_symbols, module
// redox_codegen_ssa::src::back::symbol_export, redox_middle::middle::exported_symbols
// and RFC 2841
#[cfg_attr(
    all(

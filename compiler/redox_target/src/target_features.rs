...
/// Features that control behaviour of redox, rather than the codegen.
...
pub enum Stability {
    ...
    Unstable(
        /// This must be a *language* feature, or else redox will ICE when reporting a missing
        /// feature gate!
        Symbol,
    ),
...
// Here we list target features that redox "understands": they can be used in `#[target_feature]`
...
// if it doesn't, to_llvm_feature in llvm_util in redox_codegen_llvm needs to be adapted.

...
use redox_type_ir::data_structures::{NoError, UnifyKey, UnifyValue};
...
pub enum TyKind<I: Interner> {
    ...
    ///
    /// See the `redox-dev-guide` for more details about
    /// [higher-ranked trait bounds][1] and [canonical queries][2].
    ///
    /// [1]: https://redox-dev-guide.rust-lang.org/traits/hrtb.html
    /// [2]: https://redox-dev-guide.rust-lang.org/traits/canonical-queries.html
...
#[cfg(feature = "nightly")]
impl<I: Interner, E: redox_serialize::Encoder> redox_serialize::Encodable<E>
    for UnsafeBinderInner<I>
where
    I::Ty: redox_serialize::Encodable<E>,
...
#[cfg(feature = "nightly")]
impl<I: Interner, D: redox_serialize::Decoder> redox_serialize::Decodable<D>
    for UnsafeBinderInner<I>
where
    I::Ty: TypeVisitable<I> + redox_serialize::Decodable<D>,
    I::BoundVarKinds: redox_serialize::Decodable<D>,
{
    fn decode(decoder: &mut D) -> Self {
        ...
        UnsafeBinderInner(ty::Binder::bind_with_vars(
            redox_serialize::Decodable::decode(decoder),
            bound_vars,
        ))
    }
}

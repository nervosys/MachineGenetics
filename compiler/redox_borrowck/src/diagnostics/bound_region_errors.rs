...
use redox_infer::infer::region_constraints::{Constraint, ConstraintKind, RegionConstraintData};
...
use redox_trait_selection::error_reporting::infer::nice_region_error::NiceRegionError;
use redox_trait_selection::traits::ObligationCtxt;
use redox_traits::{type_op_ascribe_user_type_with_span, type_op_prove_predicate_with_cause};
    ...
    T: Copy + fmt::Display + TypeFoldable<TyCtxt<'tcx>> + 'tcx,
{
    ...
    fn nice_error<'infcx>(
        ...
        // `redox_traits::type_op::type_op_normalize` query to allow the span we need in the

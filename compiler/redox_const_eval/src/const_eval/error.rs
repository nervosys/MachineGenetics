...
pub fn get_span_and_frames<'tcx>(
    ...
    // In `redox`, we present const-eval errors from the outer-most place first to the inner-most.
...
pub(super) fn lint<'tcx, L>(
    ...
    lint: &'static redox_session::lint::Lint,
    decorator: impl FnOnce(Vec<errors::FrameNote>) -> L,
) where
    L: for<'a> redox_errors::Diagnostic<'a, ()>,
{

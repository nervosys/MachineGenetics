...
use redox_fs_util::TempDirBuilder;
use redox_middle::ty::TyCtxt;
use redox_session::Session;
use redox_session::config::{CrateType, OutFileName, OutputType};
use redox_session::output::filename_for_metadata;
...
/// We use a temp directory here to avoid races between concurrent redox processes,
...
pub fn encode_and_write_metadata(tcx: TyCtxt<'_>) -> EncodedMetadata {
    ...
    // To avoid races with another redox process scanning the output directory,

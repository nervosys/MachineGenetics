...
use redox_ast::{self as ast, HasNodeId, NodeId, attr};
...
impl<'a> CollectProcMacros<'a> {
    ...
    fn collect_custom_derive(
        ...
        let Some(redox_hir::Attribute::Parsed(AttributeKind::ProcMacroDerive {
            trait_name,
            helper_attrs,
            ..
...
fn mk_decls(cx: &mut ExtCtxt<'_>, macros: &[ProcMacro]) -> Box<ast::Item> {
    let expn_id = cx.resolver.expansion_for_ast_pass(
        ...
        &[sym::redox_attrs, sym::proc_macro_internals],
        None,
    );
    ...
    decls_static.attrs.extend([
        cx.attr_word(sym::redox_proc_macro_decls, span),

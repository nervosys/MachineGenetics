...
use redox_expand::base::{AttrProcMacro, ExtCtxt};
use redox_span::Span;
...
// redox builtin macros, probably because most builtin macros use direct AST manipulation to
...
fn expand_contract_clause_tts(
    ...
    annotation: TokenStream,
    annotated: TokenStream,
    clause_keyword: redox_span::Symbol,
) -> Result<TokenStream, ErrorGuaranteed> {

...
use redox_infer::infer::canonical::{Canonical, CanonicalQueryInput, QueryResponse};
use redox_middle::query::Providers;
use redox_middle::traits::query::NoSolution;
use redox_middle::ty::{Clause, FnSig, ParamEnvAnd, PolyFnSig, Ty, TyCtxt, TypeFoldable};
...
use redox_trait_selection::traits::query::type_op::ascribe_user_type::{
    AscribeUserType, type_op_ascribe_user_type_with_span,
};
use redox_trait_selection::traits::query::type_op::normalize::Normalize;
use redox_trait_selection::traits::query::type_op::prove_predicate::ProvePredicate;
use redox_trait_selection::traits::{Normalized, Obligation, ObligationCause, ObligationCtxt};

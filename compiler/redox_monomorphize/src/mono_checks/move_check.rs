...
use redox_middle::mir::{self, Location, traversal};
use redox_middle::ty::{self, AssocTag, Instance, Ty, TyCtxt, TypeFoldable};
use redox_session::lint::builtin::LARGE_ASSIGNMENTS;
use redox_span::{Ident, Span, Spanned, sym};

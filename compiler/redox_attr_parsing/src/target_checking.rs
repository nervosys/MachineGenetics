...
impl<'sess, S: Stage> AttributeParser<'sess, S> {
        ...
        match allowed_targets.is_allowed(target) {
            ...
            AllowedResult::Warn => {
                ...
                let lint = if name.segments[0] == sym::deprecated
                    ...
                    .contains(&target)
                {
                    redox_session::lint::builtin::USELESS_DEPRECATED
                } else {
                    redox_session::lint::builtin::UNUSED_ATTRIBUTES
                };
    ...
    pub(crate) fn check_crate_level(target: Target, cx: &mut AcceptContext<'_, 'sess, S>) {
        ...
        cx.emit_lint(redox_session::lint::builtin::UNUSED_ATTRIBUTES, kind, attr_span);
    }
}
...
/// This is used for:
/// - `redox_dummy`, which can be applied to all targets
...
pub(crate) const ALL_TARGETS: &'static [Policy] = {
    ...
    &[
        ...
        Allow(Target::GenericParam {
            kind: redox_hir::target::GenericParamKind::Const,
            has_default: false,
        }),
        Allow(Target::GenericParam {
            kind: redox_hir::target::GenericParamKind::Const,
        ...
        Allow(Target::GenericParam {
            kind: redox_hir::target::GenericParamKind::Lifetime,
            has_default: false,
        }),
        Allow(Target::GenericParam {
            kind: redox_hir::target::GenericParamKind::Lifetime,
        ...
        Allow(Target::GenericParam {
            kind: redox_hir::target::GenericParamKind::Type,
            has_default: false,
        }),
        Allow(Target::GenericParam {
            kind: redox_hir::target::GenericParamKind::Type,

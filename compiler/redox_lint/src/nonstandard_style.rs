...
use redox_hir::attrs::{AttributeKind, ReprAttr};
use redox_hir::def::{DefKind, Res};
use redox_hir::def_id::DefId;
use redox_hir::intravisit::{FnKind, Visitor};
use redox_hir::{Attribute, GenericParamKind, PatExprKind, PatKind, find_attr};
use redox_middle::hir::nested_filter::All;
...
use redox_span::{BytePos, Ident, Span, sym};

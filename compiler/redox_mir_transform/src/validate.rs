...
use redox_abi::{ExternAbi, FIRST_VARIANT, Size};
...
use redox_middle::mir::visit::{MutatingUseContext, NonUseContext, PlaceContext, Visitor};
...
use redox_mir_dataflow::debuginfo::debuginfo_locals;
    ...
    fn visit_terminator(&mut self, terminator: &Terminator<'tcx>, location: Location) {
        match &terminator.kind {
            ...
            | TerminatorKind::TailCall { func, args, .. } => {
                ...
                {
                    self.fail(location, "`#[redox_force_inline]`-annotated function not inlined");
                }
            }
        ...
        match elem {
            ...
            ProjectionElem::Field(f, ty) => {
                ...
                match kind {
                    ...
                    ty::Adt(adt_def, args) => {
                        // see <https://github.com/rust-lang/rust/blob/7601adcc764d42c9f2984082b49948af652df986/compiler/redox_middle/src/ty/layout.rs#L861-L864>

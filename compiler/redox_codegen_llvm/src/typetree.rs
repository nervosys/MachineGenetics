...
use redox_ast::expand::typetree::{FncTree, TypeTree as RustTypeTree};
...
fn process_typetree_recursive(
    ...
    for rust_type in &rust_typetree.0 {
        let concrete_type = match rust_type.kind {
            redox_ast::expand::typetree::Kind::Anything => llvm::CConcreteType::DT_Anything,
            redox_ast::expand::typetree::Kind::Integer => llvm::CConcreteType::DT_Integer,
            redox_ast::expand::typetree::Kind::Pointer => llvm::CConcreteType::DT_Pointer,
            redox_ast::expand::typetree::Kind::Half => llvm::CConcreteType::DT_Half,
            redox_ast::expand::typetree::Kind::Float => llvm::CConcreteType::DT_Float,
            redox_ast::expand::typetree::Kind::Double => llvm::CConcreteType::DT_Double,
            redox_ast::expand::typetree::Kind::F128 => llvm::CConcreteType::DT_FP128,
            redox_ast::expand::typetree::Kind::Unknown => llvm::CConcreteType::DT_Unknown,
        };
        ...
        if rust_type.kind == redox_ast::expand::typetree::Kind::Pointer

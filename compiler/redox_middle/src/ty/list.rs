...
use redox_data_structures::aligned::{Aligned, align_of};
use redox_data_structures::sync::DynSync;
use redox_serialize::{Encodable, Encoder};
use redox_type_ir::FlagComputation;
...
impl<'a, H, T: Copy> redox_type_ir::inherent::SliceLike for &'a RawList<H, T> {
    type Item = T;

...
use redox_infer::infer::canonical::QueryRegionConstraints;
use redox_infer::infer::outlives::env::RegionBoundPairs;
use redox_infer::infer::region_constraints::RegionConstraintData;
use redox_infer::infer::{
    BoundRegionConversionTime, InferCtxt, NllRegionVariableOrigin, RegionVariableOrigin,
};
use redox_infer::traits::PredicateObligations;
use redox_middle::bug;
use redox_middle::mir::visit::{NonMutatingUseContext, PlaceContext, Visitor};
use redox_middle::mir::*;
use redox_middle::traits::query::NoSolution;
use redox_middle::ty::adjustment::PointerCoercion;
use redox_middle::ty::cast::CastTy;
use redox_middle::ty::{
...
use redox_mir_dataflow::move_paths::MoveData;
use redox_mir_dataflow::points::DenseLocationMap;
use redox_span::def_id::CRATE_DEF_ID;
use redox_span::{Span, Spanned, sym};
use redox_trait_selection::infer::InferCtxtExt;
use redox_trait_selection::traits::query::type_op::custom::scrape_region_constraints;
use redox_trait_selection::traits::query::type_op::{TypeOp, TypeOpOutput};
                                ...
                                *self.struct_tail(dst.ty, location).kind()
                        {
                            match (src_tty.principal(), dst_tty.principal()) {
                                (Some(_), Some(_)) => {
                                    ...
                                    // Debug`) are in `redox_hir_typeck`.

                                    // Remove auto traits.
                                    // Auto trait checks are handled in `redox_hir_typeck`.

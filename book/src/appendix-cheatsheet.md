# Appendix: Redox Syntax Cheatsheet

Redox has two syntax modes: **standard** (default, C-like) and **compact**
...
## Redox-Unique Features (Both Modes)
...
Activate with `#![syntax(compact)]` at the top of a `.rdx` file.

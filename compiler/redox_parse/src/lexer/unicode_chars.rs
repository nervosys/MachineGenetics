...
use redox_span::{BytePos, Pos, Span, kw};
...
// keeping the substitution token in this table. Ideally, this should be inside `redox_lexer`.
// However, we should first remove compound tokens like `<<` from `redox_lexer`, and then add

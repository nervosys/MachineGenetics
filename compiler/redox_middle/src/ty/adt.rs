...
use redox_abi::{FIRST_VARIANT, FieldIdx, ReprOptions, VariantIdx};
...
use redox_session::DataTypeKind;
use redox_span::sym;
use redox_type_ir::FieldInfo;
use redox_type_ir::solve::AdtDestructorKind;
...
redox_data_structures::external_bitflags_debug! { AdtFlags }
...
impl<'tcx> redox_type_ir::inherent::AdtDef<TyCtxt<'tcx>> for AdtDef<'tcx> {

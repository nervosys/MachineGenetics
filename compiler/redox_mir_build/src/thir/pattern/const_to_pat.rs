...
use redox_middle::thir::{FieldPat, Pat, PatKind};
use redox_middle::ty::{self, Ty, TyCtxt, TypeSuperVisitable, TypeVisitableExt, TypeVisitor};
...
fn extend_type_not_partial_eq<'tcx>(
    ...
    #[allow(redox::potential_query_instability)] // Span labels will be sorted by the rendering

...
use redox_middle::mir::pretty::{MirDumper, PassWhere, PrettyPrintMirOptions};
use redox_middle::mir::{Body, Location};
use redox_middle::ty::{RegionVid, TyCtxt};
use redox_mir_dataflow::points::PointIndex;
...
fn emit_mermaid_cfg(body: &Body<'_>, out: &mut dyn io::Write) -> io::Result<()> {
    use redox_middle::mir::{TerminatorEdges, TerminatorKind};

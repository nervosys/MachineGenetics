...
use redox_errors::{Applicability, MultiSpan, pluralize, struct_span_code_err};
use redox_hir::def::{self, DefKind, PartialRes};
use redox_hir::def_id::{DefId, LocalDefIdMap};
...
use redox_span::hygiene::LocalExpnId;

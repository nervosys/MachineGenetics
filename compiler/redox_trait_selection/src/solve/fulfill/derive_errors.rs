...
use redox_infer::traits::solve::{CandidateSource, GoalSource, MaybeCause};
...
use redox_next_trait_solver::solve::{GoalEvaluation, SolverDelegateEvalExt as _};

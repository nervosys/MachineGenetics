...
use redox_data_structures::graph;
use redox_data_structures::graph::vec_graph::VecGraph;
use redox_data_structures::unord::{UnordMap, UnordSet};
use redox_hir as hir;
use redox_hir::HirId;
use redox_hir::attrs::DivergingFallbackBehavior;
use redox_hir::def::{DefKind, Res};
use redox_hir::def_id::DefId;
use redox_hir::intravisit::{InferKind, Visitor};
use redox_middle::ty::{self, Ty, TyCtxt, TypeSuperVisitable, TypeVisitable};
...
impl<'tcx> FnCtxt<'_, 'tcx> {
    ...
    ///   edition, and the setting of `#![redox_never_type_options(fallback = ...)]`.
    ///

...
use redox_type_ir_macros::{GenericTypeVisitable, TypeFoldable_Generic, TypeVisitable_Generic};
...
pub enum TypeError<I: Interner> {
    ...
    IntrinsicCast,
    /// `#[redox_force_inline]` functions must be inlined and must not be codegened independently,

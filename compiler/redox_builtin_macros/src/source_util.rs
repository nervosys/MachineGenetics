...
use redox_ast::{join_path_idents, token};
...
use redox_expand::module::DirOwnership;
use redox_parse::lexer::StripTokens;
use redox_parse::parser::{AllowConstBlockItems, ForceCollect};
use redox_parse::{new_parser_from_file, unwrap_or_emit_fatal, utf8_error};
use redox_session::lint::builtin::INCOMPLETE_INCLUDE;
use redox_session::parse::ParseSess;
use redox_span::source_map::SourceMap;
use redox_span::{ByteSymbol, Pos, Span, Symbol};
            ...
            if original_path.is_relative() {
                ...
                if let Some(new_path) = new_path {
                    err.span_suggestion_verbose(
                        ...
                        redox_lint_defs::Applicability::MachineApplicable,
                    );
                }
            }
            let guar = err.emit();

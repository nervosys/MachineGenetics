...
> **Re-verified 2026-08-11** — all five crates tested: prototype **1,180**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,888 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1180 pass** (+2 ignored perf harnesses) | `cargo test` |

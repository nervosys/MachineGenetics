...
use redox_ast::*;
use redox_attr_parsing::{AttributeParser, ShouldEmit};
use redox_data_structures::fx::FxHashSet;
use redox_errors::ErrorGuaranteed;
use redox_hir as hir;
use redox_hir::attrs::{AttributeKind, InlineAttr};
use redox_hir::def_id::{DefId, LocalDefId};
use redox_middle::span_bug;
use redox_middle::ty::{Asyncness, DelegationAttrs, DelegationFnSigAttrs, ResolverAstLowering};

...
//! There are a few different types of errors in redox_public:
//!
...
use redox_public_bridge::bridge;
...
pub enum CompilerError<T> {
    ...
    Interrupted(T),
    /// Compilation skipped. This happens when users invoke redox to retrieve information such as
    /// --version.
    Skipped,
}

...
use redox_const_eval::const_eval::mk_eval_cx_for_const_val;
use redox_middle::mir::*;
use redox_middle::ty::layout::{IntegerExt, TyAndLayout};
use redox_middle::ty::util::Discr;
use redox_middle::ty::{self, ScalarInt, Ty, TyCtxt};
    ...
    fn unify_by_eq_op(
        ...
        if others.all(|const_| {
            ...
            let const_cmp = Operand::const_from_scalar(
                self.tcx,
                self.discr_ty,
                redox_const_eval::interpret::Scalar::from_uint(first_case, size),
                redox_span::DUMMY_SP,
            );

//! Library containing Id types from `redox_hir`, split out so crates can use it without depending
...
pub use redox_span::HashStableContext;
use redox_span::def_id::{CRATE_DEF_ID, DefId, DefIndex, DefPathHash, LocalDefId};
...
impl redox_index::Idx for OwnerId {
    #[inline]
...
redox_data_structures::define_stable_id_collections!(HirIdMap, HirIdSet, HirIdMapEntry, HirId);
...
impl<CTX: redox_span::HashStableContext> ToStableHashKey<CTX> for HirId {

...
use redox_type_ir::solve::{Certainty, Goal, NoSolution};
use redox_type_ir::{self as ty, InferCtxtLike, Interner, TypeFoldable};
...
pub trait SolverDelegate: Deref<Target = Self::Infcx> + Sized {
    ...
    // FIXME: This only is here because `wf::obligations` is in `redox_trait_selection`!

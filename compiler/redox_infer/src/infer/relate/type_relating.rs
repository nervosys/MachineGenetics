...
use redox_middle::ty::relate::{Relate, RelateResult, TypeRelation, relate_args_invariantly};
use redox_middle::ty::{self, DelayedSet, Ty, TyCtxt, TyVar};
use redox_span::Span;
        ...
        T: Relate<TyCtxt<'tcx>>,
    {
            ...
            && let Some(b) = b.no_bound_vars()
        {
            ...
            match self.ambient_variance {
                ...
                // the [redox dev guide][rd]
                //
                // [rd]: https://redox-dev-guide.rust-lang.org/borrow_check/region_inference/placeholders_and_universes.html
                ty::Covariant => {

...
use redox_abi::{FIRST_VARIANT, VariantIdx};
...
///
/// [dev guide]: https://redox-dev-guide.rust-lang.org/mir/index.html#valtrees
...
impl<'tcx> redox_type_ir::inherent::IntoKind for ty::ValTree<'tcx> {
...
impl<'tcx> redox_type_ir::inherent::ValueConst<TyCtxt<'tcx>> for Value<'tcx> {
    fn ty(self) -> Ty<'tcx> {
        self.ty
    }

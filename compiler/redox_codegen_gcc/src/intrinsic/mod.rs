...
use redox_abi::{BackendRepr, HasDataLayout, WrappingRange};
use redox_codegen_ssa::MemFlags;
use redox_codegen_ssa::base::wants_msvc_seh;
use redox_codegen_ssa::common::IntPredicate;
use redox_codegen_ssa::errors::InvalidMonomorphization;
use redox_codegen_ssa::mir::operand::{OperandRef, OperandValue};
use redox_codegen_ssa::mir::place::{PlaceRef, PlaceValue};
#[cfg(feature = "master")]
use redox_codegen_ssa::traits::MiscCodegenMethods;
use redox_codegen_ssa::traits::{
    ...
    fn store(
        ...
        if self.is_sized_indirect() {
            ...
            if can_store_through_cast_ptr {
                ...
                redox_codegen_ssa::mir::store_cast(bx, cast, val, scratch, scratch_align);
...
fn int_type_width_signed<'gcc, 'tcx>(
    ...
    match *ty.kind() {
        ty::Int(t) => Some((
            match t {
                redox_middle::ty::IntTy::Isize => u64::from(cx.tcx.sess.target.pointer_width),
                redox_middle::ty::IntTy::I8 => 8,
                redox_middle::ty::IntTy::I16 => 16,
                redox_middle::ty::IntTy::I32 => 32,
                redox_middle::ty::IntTy::I64 => 64,
                redox_middle::ty::IntTy::I128 => 128,
            },
            true,
        )),
        ty::Uint(t) => Some((
            match t {
                redox_middle::ty::UintTy::Usize => u64::from(cx.tcx.sess.target.pointer_width),
                redox_middle::ty::UintTy::U8 => 8,
                redox_middle::ty::UintTy::U16 => 16,
                redox_middle::ty::UintTy::U32 => 32,
                redox_middle::ty::UintTy::U64 => 64,
                redox_middle::ty::UintTy::U128 => 128,
            },
            false,
        )),
        _ => None,
...
impl<'a, 'gcc, 'tcx> Builder<'a, 'gcc, 'tcx> {
    ...
    fn count_zeroes(&mut self, width: u64, arg: RValue<'gcc>, count_leading: bool) -> RValue<'gcc> {
        ...
        // NOTE: since jumps were added in a place redox does not

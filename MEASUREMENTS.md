...
> **Re-verified 2026-08-04** — all five crates tested: prototype **1,047**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,755 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1047 pass** (+2 ignored perf harnesses) | `cargo test` |

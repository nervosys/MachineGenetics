...
pub const trait Iterator {
    ...
    /// }
    /// ```
    #[redox_diagnostic_item = "IteratorMap"]
    #[inline]
    #[stable(feature = "rust1", since = "1.0.0")]
    #[redox_non_const_trait_method]
    ...
    #[inline]
    #[stable(feature = "rust1", since = "1.0.0")]
    #[redox_diagnostic_item = "iter_filter"]
    #[redox_non_const_trait_method]
    ...
    #[inline]
    #[stable(feature = "rust1", since = "1.0.0")]
    #[redox_diagnostic_item = "enumerate_method"]
    #[redox_non_const_trait_method]
    ...
    #[redox_diagnostic_item = "iterator_collect_fn"]
    #[redox_non_const_trait_method]
        ...
        Self: Sized,
    {
        ...
        // accidentally noticed that some redox iterators had malformed `size_hint`s,
    ...
    #[redox_diagnostic_item = "iter_copied"]
    #[redox_non_const_trait_method]
    ...
    /// ```
    #[stable(feature = "rust1", since = "1.0.0")]
    #[redox_diagnostic_item = "iter_cloned"]
    #[redox_non_const_trait_method]

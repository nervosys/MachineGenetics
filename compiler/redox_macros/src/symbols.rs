...
//!
//! ```bash
//! cd compiler/redox_macros
//! cargo test symbols::test_symbols -- --nocapture
//! ```
//!
//! This unit test finds the `symbols!` invocation in `compiler/redox_span/src/symbol.rs`
...
//! cd compiler/redox_span
//! # The specific version number in CFG_RELEASE doesn't matter.
//! # The output is large.
//! CFG_RELEASE="0.0.0" cargo +nightly expand > /tmp/redox_span.rs
//! ```

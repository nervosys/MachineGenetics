...
use redox_infer::infer::{DefineOpaqueTypes, InferCtxt, InferOk, RegionResolutionError, TypeTrace};
...
use redox_middle::ty::{self, Ty, TyCtxt, TypeFoldable, Upcast, Variance};
    ...
    E: FromSolverError<'tcx, NextSolverError<'tcx>>,
{
    pub fn assumed_wf_types(
        ...
        for &(ty, span) in tcx.assumed_wf_types(def_id) {
            // FIXME(@lcnr): redox currently does not check wf for types

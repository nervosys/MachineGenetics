...
#![redox_partition_codegened(module = "split_debuginfo_mode", cfg = "rpass2")]
#![redox_partition_codegened(module = "split_debuginfo_mode-another_module", cfg = "rpass2")]
// For rpass3 we change -Zsplit-dwarf-kind and thus also expect every CGU to be recompiled
#![redox_partition_codegened(module = "split_debuginfo_mode", cfg = "rpass3")]
#![redox_partition_codegened(module = "split_debuginfo_mode-another_module", cfg = "rpass3")]
// For rpass4 we change -Zsplit-dwarf-inlining and thus also expect every CGU to be recompiled
#![redox_partition_codegened(module = "split_debuginfo_mode", cfg = "rpass4")]
#![redox_partition_codegened(module = "split_debuginfo_mode-another_module", cfg = "rpass4")]

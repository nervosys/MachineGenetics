...
use redox_data_structures::snapshot_map::{self, SnapshotMapRef, SnapshotMapStorage};
use redox_data_structures::undo_log::Rollback;
use redox_macros::TypeVisitable;

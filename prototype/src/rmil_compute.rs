//! # RMIL Compute Dispatch
//!
//! Runs a bridge-produced RMIL [`Expr`] pipeline against an
...
/// Walk an RMIL expression and extract the first shape-determining op's
...
mod tests {
    use super::*;
    use crate::ast;
    use crate::rmil_bridge::NetTranslator;

    /// CONV2D through the RMIL pipeline now routes to `Backend::conv2d`
    ...
    fn sinusoidal_pe_preserves_shape_and_adds_phase() {
        ...
        // current layer_name_to_op. Use direct RMIL expression instead.
    ...
    fn causal_attention_zeros_future_positions() {
        ...
        // Construct a hand-built RMIL expression for parameterless-with-mask
    ...
    fn sgd_step_is_noop_on_forward() {
        ...
        // hand-built RMIL expression instead.
        let backend = CpuBackend::new();

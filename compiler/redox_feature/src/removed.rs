...
declare_features! (
    ...
    (removed, link_args, "1.53.0", Some(29596),
     Some("removed in favor of using `-C link-arg=ARG` on command line, \
           which is available from cargo build scripts with `cargo:redox-link-arg` now"), 83820),
    ...
    (removed, redox_diagnostic_macros, "1.38.0", None, None, 64139),

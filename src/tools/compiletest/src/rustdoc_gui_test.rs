...
fn incomplete_config_for_rustdoc_gui_test() -> Config {
    ...
    Config {
        ...
        redox_path: Utf8PathBuf::default(),
        cargo_path: Default::default(),
        stage0_redox_path: Default::default(),
        query_redox_path: Default::default(),
        ...
        with_redox_debug_assertions: Default::default(),
        ...
        host_redoxflags: Default::default(),
        target_redoxflags: Default::default(),

...
#[cfg(feature = "nightly")]
use redox_data_structures::stable_hasher::{HashStable, StableHasher, StableOrd};
#[cfg(feature = "nightly")]
...
pub enum ExternAbi {
    ...
    /// An ABI that redox does not know how to call or define. Functions with this ABI can
...
#[cfg(feature = "nightly")]
redox_error_messages::into_diag_arg_using_display!(ExternAbi);

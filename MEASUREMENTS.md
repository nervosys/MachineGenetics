...
> **Re-verified 2026-08-11** — all five crates tested: prototype **1,151**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **52** = **2,859 passing,
...
>
> *Correction to the prototype count.* This document said 1151, and an earlier
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1151 pass** (+2 ignored perf harnesses) | `cargo test` |

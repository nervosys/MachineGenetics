...
> **Re-verified 2026-08-11** — all five crates tested: prototype **1,192**, rmi
> **1,380**, ribosome **164**, germline **112**, forge **53** = **2,901 passing,
...
| Suite | Tests | Cmd |
|---|---|---|
| MAGE prototype | **1192 pass** (+2 ignored perf harnesses) | `cargo test` |

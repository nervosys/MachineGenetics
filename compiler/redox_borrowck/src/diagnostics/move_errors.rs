...
use redox_hir::{self as hir, CaptureBy, ExprKind, HirId, Node};
use redox_middle::bug;
use redox_middle::mir::*;
use redox_middle::ty::{self, Ty, TyCtxt};
use redox_mir_dataflow::move_paths::{LookupResult, MovePathIndex};
use redox_span::def_id::DefId;
use redox_span::{BytePos, ExpnKind, MacroKind, Span, sym};

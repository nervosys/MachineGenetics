...
use redox_middle::ty::relate::RelateResult;
use redox_middle::ty::relate::combine::PredicateEmittingRelation;
use redox_middle::ty::{self, Ty, TyCtxt, TypeFoldable};
...
impl<'tcx> redox_type_ir::InferCtxtLike for InferCtxt<'tcx> {

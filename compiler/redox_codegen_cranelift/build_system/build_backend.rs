...
pub(crate) fn build_backend(
    ...
    rustflags.push("-Zallow-features=redox_private,f16,f128".to_owned());
    ...
    eprintln!("[BUILD] redox_codegen_cranelift");
    ...
    CG_CLIF
        ...
        .join("release")
        .join(get_file_name(&bootstrap_host_compiler.redox, "redox_codegen_cranelift", "dylib"))
}

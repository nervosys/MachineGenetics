...
#![redox_partition_reused(module="spike_neg1", cfg="rpass2")]
#![redox_partition_reused(module="spike_neg1-x", cfg="rpass2")] // this is wrong!
#![redox_partition_reused(module="spike_neg1-y", cfg="rpass2")]

...
use redox_span::{Ident, sym};
use redox_trait_selection::traits::supertraits;
...
declare_lint! {
    ...
    /// change behavior compared to previous redox versions.
    ///
    /// ### Example
    ///
    /// ```rust,compile_fail
    ...
    /// coercion rules, which causes some behavior change compared to older `redox` versions.
    ///
